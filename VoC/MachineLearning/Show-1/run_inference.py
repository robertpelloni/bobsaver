...
# pretrained_model_path = "showlab/show-1-base-0.0"
pretrained_model_path = args2.model
...
prompt = args2.prompt
extension = args2.extension
output_dir = args2.output_dir #"./outputs/template"
...
sys.stdout.write("Generating keyframes ...\n")
sys.stdout.flush()
...
sys.stdout.write("Interpolating keyframes ...\n")
sys.stdout.flush()
...
for i in range(num_frames - 1):
    sys.stdout.write(f"Interpolating keyframe {i+1}/{num_frames-1} ...\n")
    sys.stdout.flush()
...
sys.stdout.write("Upscaling pass 1 ...\n")
sys.stdout.flush()
...
sys.stdout.write("Upscaling pass 2 ...\n")
sys.stdout.flush()
...
imageio.mimsave(f"{output_dir}/{prompt}.{extension}",
                tensor2vid(video_frames.clone()),
                fps=8)
