...
# Original file is located at https://colab.research.google.com/drive/1Pf5F84FzWe9iAKNbiPaEo_v4hvQZ9SqS
...
def parse_args():
  ...
  parser.add_argument('--perlin', type=int, help='Perlin noise init')
  parser.add_argument('--model_version', type=int, help='Secondary model version')
...
if args.model_version == 1:
    sys.stdout.write("Loading secondary_model_imagenet model ...\n")
    sys.stdout.flush()
...
if args.model_version == 2:
    sys.stdout.write("Loading secondary_model_imagenet model_2 ...\n")
    sys.stdout.flush()
...
sat_scale = 0 #args.saturationscale #0 # 0 - Controls how much saturation is allowed. From nshepperd's JAX notebook.
