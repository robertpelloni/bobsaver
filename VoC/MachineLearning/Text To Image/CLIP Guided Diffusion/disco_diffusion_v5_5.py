# Disco Diffusion v5.5 [Now with Pixel Art Diffusion, Watercolor, Pulp Sci-Fi, and OpenCLIP models]
...
import open_clip
sys.path.append(f'{PROJECT_DIR}/guided-diffusion-5-5')
...
sys.path.append(f'{PROJECT_DIR}/disco-diffusion-5-5')
...
diffusion_model = args3.diffusion_model #@param ["256x256_diffusion_uncond", "512x512_diffusion_uncond_finetune_008100", "pixelartdiffusion_expanded", "pixel_art_diffusion_hard_256", "pixel_art_diffusion_soft_256", "pixelartdiffusion4k", "watercolordiffusion_2", "watercolordiffusion", "PulpSciFiDiffusion", "custom"]
if args3.use_secondary_model == 1:
  use_secondary_model = True #@param {type: 'boolean'}
else:
  use_secondary_model = False #@param {type: 'boolean'}

diffusion_sampling_mode = args3.diffusion_sampling_mode #'ddim' #@param ['plms','ddim']
...
#no need for this as VoC already checksums after downloading the models
...
diff_model_map = {
    ...
    'watercolordiffusion': { 'downloaded': False, 'sha': 'a3e6522f0c8f278f90788298d66383b11ac763dd5e0d62f8252c962c23950bd6', 'uri_list': ['https://huggingface.co/KaliYuga/watercolordiffusion/resolve/main/watercolordiffusion.pt'] },
    'PulpSciFiDiffusion': { 'downloaded': False, 'sha': 'b79e62613b9f50b8a3173e5f61f0320c7dbb16efad42a92ec94d014f6e17337f', 'uri_list': ['https://huggingface.co/KaliYuga/PulpSciFiDiffusion/resolve/main/PulpSciFiDiffusion.pt'] },
    '256x256_openai_comics_faces_v2.by_alex_spirin_114k': { 'downloaded': False, 'sha': '7bac93342ed8efb04160dbed754bce69581ec228ec302a60681156b9d64856e6', 'uri_list': ['https://github.com/Sxela/DiscoDiffusion-Warp/releases/download/v0.1.1/256x256_openai_comics_faces_v2.by_alex_spirin_114k.pt'] },
...
elif diffusion_model == 'portrait_generator_v001_ema_0.9999_1M':
    model_config.update({
        'attention_resolutions': '32, 16, 8',
        'class_cond': False,
...
batch_name = args3.batch_name #'TimeToDisco' #@param{type: 'string'}
steps = args3.iterations #@param [25,50,100,150,250,500,1000]{type: 'raw', allow-input: true}
width_height_for_512x512_models = [args3.sizex, args3.sizey] #@param{type: 'raw'}

clip_guidance_scale = args3.clip_guidance_scale #5000 #@param{type: 'number'}
tv_scale = args3.tv_scale #0#@param{type: 'number'}
range_scale = args3.range_scale #150#@param{type: 'number'}
sat_scale = args3.sat_scale #0#@param{type: 'number'}
cutn_batches = args3.cutn_batches #4#@param{type: 'number'}
...
width_height_for_256x256_models = [args3.sizex, args3.sizey] #@param{type: 'raw'}
...
init_image = args3.init_image #None #@param{type: 'string'}
#@markdown `frame_scale` tries to guide the new frame to looking like the old one. A good default is 1500.
video_init_frames_scale = args3.video_init_frames_scale #15000 #@param{type: 'integer'}
#@markdown `frame_skip_steps` will blur the previous frame - higher values will flicker less but struggle to add enough new detail to zoom into.
video_init_frames_skip_steps = args3.video_init_frames_skip_steps #'70%' #@param ['40%', '50%', '60%', '70%', '80%'] {type: 'string'}
...
cut_overview = args3.cut_overview #"[12]*400+[4]*600" #@param {type: 'string'}       
cut_innercut = args3.cut_innercut #"[4]*400+[12]*600"#@param {type: 'string'}  
cut_ic_pow = args3.cut_ic_pow #1#@param {type: 'string'}  
cut_icgray_p = args3.cut_icgray_p #"[0.2]*400+[0]*600"#@param {type: 'string'}
...
pad_or_pulp_cut_overview = args3.pad_or_pulp_cut_overview #"[15]*100+[15]*100+[12]*100+[12]*100+[6]*100+[4]*100+[2]*200+[0]*200" #@param {type: 'string'}
pad_or_pulp_cut_innercut = args3.pad_or_pulp_cut_innercut #"[1]*100+[1]*100+[4]*100+[4]*100+[8]*100+[8]*100+[10]*200+[10]*200" #@param {type: 'string'}
pad_or_pulp_cut_ic_pow = args3.pad_or_pulp_cut_ic_pow #"[12]*300+[12]*100+[12]*50+[12]*50+[10]*100+[10]*100+[10]*300" #@param {type: 'string'}
pad_or_pulp_cut_icgray_p = args3.pad_or_pulp_cut_icgray_p #"[0.87]*100+[0.78]*50+[0.73]*50+[0.64]*60+[0.56]*40+[0.50]*50+[0.33]*100+[0.19]*150+[0]*400" #@param {type: 'string'}

watercolor_cut_overview = args3.watercolor_cut_overview #"[14]*200+[12]*200+[4]*400+[0]*200" #@param {type: 'string'}
watercolor_cut_innercut = args3.watercolor_cut_innercut #"[2]*200+[4]*200+[12]*400+[12]*200" #@param {type: 'string'}
watercolor_cut_ic_pow = args3.watercolor_cut_ic_pow #"[12]*300+[12]*100+[12]*50+[12]*50+[10]*100+[10]*100+[10]*300" #@param {type: 'string'}
watercolor_cut_icgray_p = args3.watercolor_cut_icgray_p #"[0.7]*100+[0.6]*100+[0.45]*100+[0.3]*100+[0]*600" #@param {type: 'string'}
...
transformation_percent = [args3.transformation_percent] #@param
...
0: [phrase.strip() for phrase in args3.prompt.split("|") ]
...
n_batches = args3.n_batches #1 #@param{type: 'number'}
...
if args3.resume_run == 1:
    resume_run = True #@param{type: 'boolean'}
else:
    resume_run = False #@param{type: 'boolean'}
run_to_resume = args3.run_to_resume #'latest' #@param{type: 'string'}
resume_from_frame = args3.resume_from_frame #'latest' #@param{type: 'string'}
if args3.retain_overwritten_frames == 1:
