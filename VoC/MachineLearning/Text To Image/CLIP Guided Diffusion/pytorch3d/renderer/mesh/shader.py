...
class HardPhongShader(nn.Module):
    ...
    .. code-block::
        ...
        shader = HardPhongShader(device=torch.device("cuda"))
    """
...
class SoftPhongShader(nn.Module):
    ...
    .. code-block::
        ...
        shader = SoftPhongShader(device=torch.device("cuda"))
    """
...
class HardGouraudShader(nn.Module):
    ...
    .. code-block::
        ...
        shader = HardGouraudShader(device=torch.device("cuda"))
    """
...
class SoftGouraudShader(nn.Module):
    ...
    .. code-block::
        ...
        shader = SoftGouraudShader(device=torch.device("cuda"))
    """
...
class HardFlatShader(nn.Module):
    ...
    .. code-block::
        ...
        shader = HardFlatShader(device=torch.device("cuda"))
    """
