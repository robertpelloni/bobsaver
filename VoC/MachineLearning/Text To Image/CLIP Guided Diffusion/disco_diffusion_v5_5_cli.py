...
text_prompts = {
    ...
    #0: ["a portrait of a beautiful young girl in a garden at dusk"],
    #0: ["a highly detailed matte painting of lovecraftian horrors"],
    0: ["a giant aztec temple a reflecting pool in front, stars and moon in the background at dawn"],
