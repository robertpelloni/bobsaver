# Disco Diffusion v5 Turbo and Smoothing [w/ 3D animation]
# Original file is located at https://colab.research.google.com/github/zippy731/disco-diffusion-turbo/blob/main/Disco_Diffusion_v5_Turbo_%5Bw_3D_animation%5D.ipynb
...
def do_run():
  turbo_blend = False #stops an error about variable not yet defined lower down
  seed = args.seed
      ...
      if args.animation_mode == "3D":
        ...
        if frame_num > 0:
          ...
          if turbo_mode == True and frame_num > turbo_preroll:
            ...
            old_frame = dxf.transform_image_3d('oldFrameScaled.png', midas_model, midas_transform, DEVICE,
                                                 rot_mat, translate_xyz, args.near_plane, args.far_plane,
                                                 args.fov, padding_mode=args.padding_mode,
                                                 sampling_mode=args.sampling_mode, midas_weight=args.midas_weight)
...
text_prompts = {
    ...
    #0: ["disturbing bloody slimy horror flesh"],
    0: ["a detailed matte painting of dense woodland"],
