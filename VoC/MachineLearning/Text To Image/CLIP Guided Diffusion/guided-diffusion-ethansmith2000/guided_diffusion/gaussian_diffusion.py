...
#                     return x/(maxval * th.tanh((x**3)/2))
    ...
    def IPLMS_to_DDIM_sample_loop_progressive(
        self,
        model,
        shape,
        noise=None,
    ...
    def PLMS_to_DDIM_sample_loop_progressive(
        self,
        model,
        shape,
        noise=None,
        ...
        """
        Use IPLMS first, then switch to DDIM mid-render to reduce grainy output.
