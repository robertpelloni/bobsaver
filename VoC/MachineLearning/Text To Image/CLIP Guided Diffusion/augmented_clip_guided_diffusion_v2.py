...
# Original file is located at https://colab.research.google.com/github/pbaylies/Augmented_CLIP/blob/main/Augmented_CLIP_Guided_Diffusion_HQ_256x256_and_512x512-Copy1.ipynb
...
clip_guidance_scale = args.guidancescale #5000 # 1000 - Controls how much the image should look like the prompt.
...
cutn = args.cutn #4 # 16 - Controls how many crops to take from the image.
...
if args.denoised == 0:
    clip_denoised = False #False # False - Determines whether CLIP discriminates a noisy or denoised image
else:
    clip_denoised = True #False # False - Determines whether CLIP discriminates a noisy or denoised image
...
n_batches = 1 #4 # 1 - Controls how many consecutive batches of images are generated
