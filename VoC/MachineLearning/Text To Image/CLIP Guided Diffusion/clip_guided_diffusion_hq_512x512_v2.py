...
model_config.update({
    ...
    'timestep_respacing': str(args.iterations),  # Modify this value to decrease the number of timesteps.
    'image_size': 512,
    'learn_sigma': True,
...
if init_image==None:
    ...
    skip_timesteps = 100  # This needs to be between approx. 200 and 500 when using an init image.
                          # Higher values make the output look more like the init.
