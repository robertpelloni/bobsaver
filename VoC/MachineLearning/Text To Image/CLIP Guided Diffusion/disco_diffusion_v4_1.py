...
# Original file is located at https://colab.research.google.com/drive/1sHfRn5Y0YKYKi1k-ifUSBFRNJ8_1sa39
...
model_256_path = '256x256_diffusion_uncond.pt'
model_512_path = '512x512_diffusion_uncond_finetune_008100.pt'
model_secondary_path = 'secondary_model_imagenet_2.pth'
...
"""
#this really should be the version of the above code
if args2.seed_image is not None:
    init_image = args2.seed_image   # This can be an URL or Colab local path and must be in quotes.
else:
    init_image = ''   # This can be an URL or Colab local path and must be in quotes.
...
args = {
    'batchNum': batchNum,
    'prompts_series':text_prompts, #split_prompts(text_prompts) if text_prompts else None,
    'image_prompts_series':None, #split_prompts(image_prompts) if image_prompts else None,
    'seed': seed,
