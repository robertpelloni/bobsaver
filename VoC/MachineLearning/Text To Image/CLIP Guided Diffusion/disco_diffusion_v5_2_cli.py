...
#@title ### 1.29 Downgrade Pytorch for Vit14 compat. (skipping)
#@markdown ONLY use if you've got V100 or T4, and when using VITL14 models 
#!pip install torch==1.10.2 torchvision==0.11.3 -q

#here is to reupgrade pytorch
#!pip install --upgrade --force-reinstall torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cu113
...
batch_name = 'Time_To_Disco_ColorFX' #@param{type: 'string'}
...
frames_skip_steps = '75%' #@param ['40%', '50%', '60%', '65%', '70%', '75%','80%'] {type: 'string'}
...
frames_skip_end_steps = 10 #@param{type: 'integer'}
...
copy_palette_image = "D://ocean.jpg" #content/drive/MyDrive/AI/Disco_Diffusion/init_images/beach.jpg" #@param{type: 'string'}
