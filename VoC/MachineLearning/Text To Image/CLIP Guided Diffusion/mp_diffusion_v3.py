...
def parse_args():
  ...
  parser.add_argument('--skipaugs', type=int, help='Skip augments.')
...
if secondary_model_ver == 2:
    ...
    secondary_model.load_state_dict(torch.load(f'secondary_model_imagenet_2.pth', map_location='cpu'))
...
clamp_max = 0.02 #@param{type: 'number'}
