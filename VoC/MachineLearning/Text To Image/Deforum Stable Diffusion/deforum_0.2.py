...
def DeforumAnimArgs():
    ...
    max_frames = 350 #1000#@param {type:"number"}
...
animation_prompts = {
    0: args2.prompt,
    #0: "nightmare faces by giger beksinski dali trending on artstation 4K HD hyperrealistic",
    #0: "a photorealistic portrait of evil clowns",
...
def DeforumArgs():
    ...
    n_samples = args2.n_samples #1 # hidden
    W = args2.W
    H = args2.H
    ...
    sampler = args2.sampler #'klms' #args2.sampler #'klms' #@param ["klms","dpm2","dpm2_ancestral","heun","euler","euler_ancestral","plms", "ddim"]
    steps = args2.ddim_steps #50 #@param
    scale = args2.scale #14 #7 #@param
    ddim_eta = 0.0 #@param
