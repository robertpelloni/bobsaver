...
if __name__ == "__main__":
    ...
    try:
        ...
        if 'metrics_over_trainsteps_checkpoint' in callbacks_cfg:
            print('Caution: Saving checkpoints every n train steps without deleting. This might require some free space.', flush=True)
        ...
        def melk(*args, **kwargs):
            ...
            if trainer.global_rank == 0:
                print("Saving last.ckpt checkpoint...", flush=True)
                ckpt_path = os.path.join(ckptdir, "last.ckpt")
                #ckpt_path = f"last {checkpoint_count+1:05}.ckpt"
                trainer.save_checkpoint(ckpt_path)
