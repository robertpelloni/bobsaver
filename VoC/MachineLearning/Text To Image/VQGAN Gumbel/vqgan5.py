# https://colab.research.google.com/drive/1tim3xTsZXafK-A2rOUsevckdl4OitIiw
...
texts = args.prompts #"a painting of a cabin next to a stream in a secluded forest" #"a drawing of new ethics, artstation, 2D" #@param {type:"string"}
width =  args.sizex #@param {type:"number"}
height = args.sizey #@param {type:"number"}
model = args.vqgan_model #"vqgan_imagenet_f16_16384" #@param ["vqgan_imagenet_f16_16384", "vqgan_imagenet_f16_1024", "wikiart_1024", "wikiart_16384", "coco", "faceshq", "sflckr"]
images_interval =  args.update #@param {type:"number"}
init_image = "" #"https://www.kindpng.com/picc/m/156-1561276_purple-blue-pink-stone-shape-abstract-banner-circle.png"#@param {type:"string"}
...
def checkin(i, losses):
    ...
    out = synth(z)
    TF.to_pil_image(out[0].cpu()).save(args.image_file)
