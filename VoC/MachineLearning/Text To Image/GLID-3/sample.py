...
parser.add_argument('--iterations', type = str, default = '25', required = True,
                    help='Iterations')
...
parser.add_argument('--image_file') # output image file name from VoC
...
model_params = {
    ...
    'timestep_respacing': args.iterations, #'27',  # Modify this value to decrease the number of
                                   # timesteps.
    'image_size': 32,
    'learn_sigma': True,
