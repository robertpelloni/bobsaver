# The Big Sleep Customized by NMKD
# Original file is located at https://colab.research.google.com/drive/1Q2DIeMqYm_Sc5mlurnnurMMVqlgXpZNO
...
#@markdown Your text prompt:
promptInput = args.input_phrase
...
# Set prompt
im_shape = [args.image_size, args.image_size, 3]
sideX, sideY, channels = im_shape
prompt = promptInput
tx = clip.tokenize(f'''{prompt}''')
