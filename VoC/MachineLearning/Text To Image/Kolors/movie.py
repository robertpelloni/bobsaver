...
#VOC START - DO NOT DELETE
    "0:hyperrealistic surrealist oil painting of horror, 4k, 8k",
...
if args2.in_script_movie == 1:
    ...
    sys.stdout.write(f"Setting up KolorsPipeline ...\n")
    sys.stdout.flush()
    ...
    sys.stdout.flush()
    sys.stdout.write('Deleting KolorsPipeline ...\n')
    sys.stdout.flush()
    del pipe
    ...
    #setup img2img model
    sys.stdout.write(f"Setting up KolorsImg2ImgPipeline ...\n")
    sys.stdout.flush()
