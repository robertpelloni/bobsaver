...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--epochs_per_checkpoint", type=int, help="How many epochs to save each checkpoint after.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        #print(f'*******************opt.epochs_per_checkpoint={opt.epochs_per_checkpoint}')
                ...
                'metrics_over_trainsteps_checkpoint':
                    {"target": 'pytorch_lightning.callbacks.ModelCheckpoint',
                     'params': {
                         ...
                         "verbose": True,
                         'save_top_k': -1,
                         'every_n_train_steps': 1000, #10000,
