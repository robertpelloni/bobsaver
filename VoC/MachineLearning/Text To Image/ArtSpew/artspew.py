...
def main():
    ...
    for image in image_generator:
        ...
        outputname_prefix = f"{args.output_dir}{image.filename_prefix}{sequence_number:09d}"
        outputname = outputname_prefix + safe_prompt[:250-len(outputname_prefix)]
        image.save(f"{outputname}.png")
