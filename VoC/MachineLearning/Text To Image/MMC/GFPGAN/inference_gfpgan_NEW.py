...
# model wget https://github.com/TencentARC/GFPGAN/releases/download/v1.3.0/GFPGANv1.3.pth -P experiments/pretrained_models
...
def main():
    ...
    parser.add_argument(
        '--model_name', type=str, help='Model filename, ie GFPGANv1.3.pth')
    parser.add_argument(
    ...
    for img_path in img_list:
        ...
        if restored_img is not None:
            ...
            """
            if args.suffix is not None:
                save_restore_path = os.path.join(args.output, f'{basename}{args.suffix}.{extension}')
            else:
