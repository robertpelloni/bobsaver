# Mse regularized Modified_VQGANCLIP_zquantize public.ipynb
...
def parse_args():
  ...
  parser.add_argument('--initweight', type=float, help='Init weight.')
...
args = argparse.Namespace(
    ...
    noise_prompt_seeds = [args2.seed],#

    # mse settings
    mse_withzeros = True,
    mse_decay_rate = args2.msedecayrate, #50,
    mse_epoches = 5,
    mse_quantize = True,
