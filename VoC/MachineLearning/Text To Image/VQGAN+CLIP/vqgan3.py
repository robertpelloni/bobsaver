...
# Original file is located at https://colab.research.google.com/drive/1go6YwMFe5MX6XM9tv-cnQiSTU50N9EeT
...
args = argparse.Namespace(
    ...
    image_prompts=[], # can be prompts divided by | characters?
    noise_prompt_seeds=[],
...
class MakeCutouts(nn.Module):
    def __init__(self, cut_size, cutn, cut_pow=1.):
        ...
        self.augs = nn.Sequential(
            ...
            K.RandomSharpness(0.6,p=0.4), # was 0.3 0.4
            K.RandomAffine(degrees=30, translate=0.1, p=0.8, padding_mode='border'),
            K.RandomPerspective(0.7,p=0.7),
            # K.RandomAffine(degrees=0, translate=0, scale=[1.1,1.1], p=1.0, padding_mode='border'),
...
#@title Parámetros
textos = args.prompts #"a fantasy world" #@param {type:"string"}
ancho =  args.sizex #480#@param {type:"number"}
alto =  args.sizey #480#@param {type:"number"}
modelo = args.vqgan_model #"vqgan_imagenet_f16_16384" #@param ["vqgan_imagenet_f16_16384", "vqgan_imagenet_f16_1024", "wikiart_1024", "wikiart_16384", "coco", "faceshq", "sflckr"]
intervalo_imagenes =  args.update #@param {type:"number"}
...
toksX, toksY = args.sizex // f, args.sizey // f
...
def checkin(i, losses):
    ...
    if args2.r is not None:
        ...
        z.requires_grad_(True)
        opt = optim.Adam([z], lr=args2.learning_rate)
