# AI Art Machine
# Original file is located at https://colab.research.google.com/drive/1n_xrgKDlGQcCF6O-eL3NOd_x4NSqAUjK
...
def parse_args():
  ...
  parser.add_argument('--flavor', type=str, help='Flavor.', default=None)
...
p = args2.prompt
image_width = args2.sizex
image_height = args2.sizey
total_steps = args2.iterations
steps_per_image = args2.update
flavor = args2.flavor
seed = args2.seed
...
toksX, toksY = image_width // f, image_height // f
...
def checkin(i, losses):
    ...
    out_img = TF.to_pil_image(out[0].cpu()).resize((args2.sizex, args2.sizey), Image.LANCZOS)
    out_img.save(args2.image_file)
