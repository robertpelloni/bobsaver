...
# Original file is located at https://colab.research.google.com/drive/1wkF67ThUz37T2_oPIuSwuO4e_-0vjaLs
...
model_name = args2.clip_model
#seed = 42

texts = args2.prompt #'cyberpunk forest by Salvador Dali' #@param {type:"string"}
width = args2.sizex #@param {type:"integer"}
height = args2.sizey #@param {type:"integer"}
...
#@markdown ---
learning_rate = args2.learning_rate #@param {type:"slider", min:0.00, max:0.30, step:0.01}
max_steps = args2.iterations #@param {type:"integer"}
images_interval = args2.update #@param {type:"integer"}
...
def ascend_txt():
    ...
    img.save("Progress.png", pnginfo=metadata)
    return result
