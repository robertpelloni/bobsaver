# convert mp3 to wav
# for /r %i in (*.mp3) do ffmpeg -i %i %i.wav
...
def parse_args():
    ...
    parser.add_argument("--config-file", type=str, help="Name of config i.e. Defaults.ini")
...
class DemoCallback(pl.Callback):
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx):        
        ...
        try:
            ...
            torchaudio.save(os.path.join(self.save_path, filename), fakes, self.sample_rate)
