...
def main():
    ...
    if not os.path.isfile('234_sketch.jpg'):
        torch.hub.download_url_to_file('https://raw.githubusercontent.com/williamyang1991/StyleGANEX/main/data/234_sketch.jpg','234_sketch.jpg')
    if not os.path.isfile('ILip77SbmOE_inversion.pt'):
        torch.hub.download_url_to_file('https://github.com/williamyang1991/StyleGANEX/raw/main/output/ILip77SbmOE_inversion.pt','ILip77SbmOE_inversion.pt')
    if not os.path.isfile('ILip77SbmOE.png'):
        torch.hub.download_url_to_file('https://raw.githubusercontent.com/williamyang1991/StyleGANEX/main/data/ILip77SbmOE.png','ILip77SbmOE.png')
    if not os.path.isfile('ILip77SbmOE_mask.png'):
        torch.hub.download_url_to_file('https://raw.githubusercontent.com/williamyang1991/StyleGANEX/main/data/ILip77SbmOE_mask.png','ILip77SbmOE_mask.png')
    if not os.path.isfile('pexels-daniel-xavier-1239291.jpg'):
        torch.hub.download_url_to_file('https://raw.githubusercontent.com/williamyang1991/StyleGANEX/main/data/pexels-daniel-xavier-1239291.jpg','pexels-daniel-xavier-1239291.jpg')
    if not os.path.isfile('529_2.mp4'):
        torch.hub.download_url_to_file('https://github.com/williamyang1991/StyleGANEX/raw/main/data/529_2.mp4','529_2.mp4')
    if not os.path.isfile('684.mp4'):
        torch.hub.download_url_to_file('https://github.com/williamyang1991/StyleGANEX/raw/main/data/684.mp4','684.mp4')
    if not os.path.isfile('pexels-anthony-shkraba-production-8136210.mp4'):
        torch.hub.download_url_to_file('https://github.com/williamyang1991/StyleGANEX/raw/main/data/pexels-anthony-shkraba-production-8136210.mp4','pexels-anthony-shkraba-production-8136210.mp4')        
