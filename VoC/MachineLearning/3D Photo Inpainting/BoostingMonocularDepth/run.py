...
def run(dataset, option):
    ...
    #print("finished processing patches - please wait for other parts to finish")
    print("Please wait.  The script has not crashed.")
    print("It can take a few minutes without feedback at this point.")
