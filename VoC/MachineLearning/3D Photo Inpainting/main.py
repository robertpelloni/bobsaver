...
for idx in tqdm(range(len(sample_list))):
    ...
    if not(config['load_ply'] is True and os.path.exists(mesh_fi)):
        ...
        depth_edge_weight = torch.load('checkpoints/edge-model.pth',map_location=torch.device(device))
        ...
        depth_feat_weight = torch.load('checkpoints/depth-model.pth',map_location=torch.device(device))
        ...
        rgb_feat_weight = torch.load('checkpoints/color-model.pth',map_location=torch.device(device))
