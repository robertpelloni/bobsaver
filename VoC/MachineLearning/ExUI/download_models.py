...
def select_model_from_default_options():
    models = {
        ...
        "Wizard-Vicuna-7B-Uncensored-GPTQ (4.21 GB)": ("TheBloke", "Wizard-Vicuna-7B-Uncensored-GPTQ", "main"),
        "Wizard-Vicuna-13B-Uncensored-GPTQ (7.55 GB)": ("TheBloke", "Wizard-Vicuna-13B-Uncensored-GPTQ", "main"),
        "WizardLM-7B-Uncensored-GPTQ (3.62 GB)": ("TheBloke", "WizardLM-7B-Uncensored-GPTQ", "main"),
        "WizardLM-30B-Uncensored-GPTQ (15.7 GB)": ("TheBloke", "WizardLM-30B-Uncensored-GPTQ", "main"),
    }
    choices = {}

    print("\nSelect the model that you want to download.\nThe llama3 model is a good start if you are not sure.\n")
