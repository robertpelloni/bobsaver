...
MODELS = {
    'Malevich': dict(
        description='Malevich is 1.3 billion params model from the family GPT3-like, '
...
#def get_rudalle_model(name, pretrained=True, fp16=False, device='cpu', cache_dir='./cache'):
def get_rudalle_model(name, pretrained=True, fp16=False, device='cpu', cache_dir=''):
    # TODO docstring
