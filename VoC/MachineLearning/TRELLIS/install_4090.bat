...
cd
echo *** %time% *** Installing 4090 TRELLIS
...
echo *** %time% *** Downloading 4090 wheels
curl -L -o TRELLIS_4090.rar https://huggingface.co/datasets/Softology-Pro/VoC/resolve/main/TRELLIS_4090.rar -v

echo *** %time% *** Extracting 4090 wheels
..\7z x TRELLIS_4090.rar

echo *** %time% *** Installing 4090 wheels
