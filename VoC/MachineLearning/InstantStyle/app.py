    ...
    with gr.Tabs():
        with gr.Row():
            with gr.Column():
                ...
                target = gr.Dropdown(["Load original IP-Adapter","Load only style blocks","Load style+layout block"], label="Load Style", info="IP-Adapter Layers", value="Load only style blocks")
