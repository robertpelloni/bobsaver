...
def main():
    ...
    parser.add_argument('--output', type=str, default='.', help='Output image name')
    ...
    parser.add_argument('--suffix', type=str, default='Real ESRGAN PyTorch zoomed x', help='Suffix of the restored image')
    ...
    try:
        ...
        if img_mode == 'RGBA':  # RGBA images should be saved in png format
            extension = 'png'
        #save_path = os.path.join(args.output, f'{imgname} {args.suffix}{args.outscale}.{extension}')
        print(f'Saving output as {args.output}...\n')
