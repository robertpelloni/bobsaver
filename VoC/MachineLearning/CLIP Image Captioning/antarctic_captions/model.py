...
class Model(pl.LightningModule):
    ...
    def __init__(self, args=None, cache=None, cache_emb=None):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('facebook/bart-large', cache_dir=self.hparams.datadir)
        self.model = AutoModelForSeq2SeqLM.from_pretrained('facebook/bart-large', cache_dir=self.hparams.datadir)
        #self.tokenizer = AutoTokenizer.from_pretrained('facebook/bart-large', cache_dir='.')
        #self.model = AutoModelForSeq2SeqLM.from_pretrained('facebook/bart-large', cache_dir='.')
        self.cache = cache
