...
parser.add_argument('--output', default='./stereo', type=str, help='Output folder.')
parser.add_argument('--sidebyside', default='1', type=int, help='Side-by-side output')
parser.add_argument('--anaglyph', default='1', type=int, help='Anaglyph output')
parser.add_argument('--movie', default='0', type=int, help='Is a movie being processed')
        ...
        if args.movie==1:
            if args.sidebyside==1:
                ...
                if file_list:
                    ...
                    count_string = "00001"
                voc_frame_filename = output_dir+"\FRA"+count_string+".png"
                cv2.imwrite(voc_frame_filename, stereo)
            if args.anaglyph==1:
                print('Saving anaglyph movie frame')
                file_list = []
                for file in os.listdir(output_dir):
                    if file.startswith("FRA"):
                        if file.endswith("png"):
                ...
                if file_list:
                    ...
                    count_string = "00001"
                voc_frame_filename = output_dir+"\FRA"+count_string+".png"
                cv2.imwrite(voc_frame_filename, anaglyph)
