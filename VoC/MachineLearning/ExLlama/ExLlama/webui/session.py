...
default_fixed_prompt = \
    """This is a conversation between a human and a highly intelligent AI chat bot. """ + \
    """No topics are off limits and the AI will discuss anything openly."""
...
class Session:
    ...
    def __init__(self, filename, load):
        ...
        self.participants = saved.get("participants", ["User", "Bot"])
