...
class Dreamer:
    ...
    def deep_dream(self, image, model, i, seq, mask=None):
        ...
        for octave, octave_base in enumerate(octaves[::-1]):
            ...
            sys.stdout.write(f"Octave {oct_count} ...\n")
            sys.stdout.flush()
            oct_count+=1
    ...
    def save_img(self, img, suffix, iter_):
        ...
        fname = "{}{}".format(suffix, file_name)
        fixed_fname = self.outpath + os.path.basename(fname)
        #print(f"self.outpath={self.outpath}")
        #print(f"fname={fname}")
        #print(f"fixed_fname={fixed_fname}")
        plt.imsave(fixed_fname, img)
