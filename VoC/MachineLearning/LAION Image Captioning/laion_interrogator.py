# laion_interrogator.ipynb
# Original file is located at https://colab.research.google.com/github/voctory/laion-interrogator/blob/main/laion_interrogator.ipynb
...
clip_model_choice = 'ViT-H-14/laion2b_s32b_b79k' #@param ['ViT-L-14/laion2b_s32b_b82k', 'ViT-H-14/laion2b_s32b_b79k', 'ViT-g-14/laion2b_s12b_b42k'] {type:'string'}
(clip_model_name, clip_model_pretrained_name) = clip_model_choice.split('/', 2)
# clip_model, clip_preprocess = clip.load(clip_model_name, device="cuda")
clip_model, _, clip_preprocess = clip.create_model_and_transforms(clip_model_name, pretrained=clip_model_pretrained_name)
# clip_model, _, clip_preprocess = clip.create_model_and_transforms('ViT-L-14', pretrained='laion2b_s32b_b82k')
# clip_model, _, clip_preprocess = clip.create_model_and_transforms('ViT-H-14', pretrained='laion2b_s32b_b79k')
# clip_model, _, clip_preprocess = clip.create_model_and_transforms('ViT-g-14', pretrained='laion2b_s12b_b42k')
...
sys.stdout.write(f'\n{str(prompt).encode(sys.stdout.encoding, errors="ignore").decode(sys.stdout.encoding)}\n')
