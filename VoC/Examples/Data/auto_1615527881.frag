...
// Random Cycle
    ...
    cyw[0] = dvmd[24] * lc * 1.0;
    cyw[1] = dvmd[25] * lc * 1.0;
    cyw[2] = dvmd[26] * lc * 1.0;
    cyw[3] = dvmd[27] * lc * 1.0;
    cyw[4] = dvmd[28] * lc * 1.0;
    cyw[5] = dvmd[29] * lc * 1.0;
    cyc_r = (res_r * 1.0 + res_g * cyw[0] + res_b * cyw[1] ) / (1.0 + (cyw[0]+cyw[1]));
    cyc_g = (res_r * cyw[3] + res_g * 1.0 + res_b * cyw[2] ) / (1.0 + (cyw[2]+cyw[3]));
    cyc_b = (res_r * cyw[4] + res_g * cyw[5] + res_b * 1.0 ) / (1.0 + (cyw[4]+cyw[5]));
    res_r = cyc_r;
    ...
    cyw[0] = dvmd[30] * lc * 1.0;
    cyw[1] = dvmd[31] * lc * 1.0;
    cyw[2] = dvmd[32] * lc * 1.0;
    cyw[3] = dvmd[33] * lc * 1.0;
    cyw[4] = dvmd[34] * lc * 1.0;
    cyw[5] = dvmd[35] * lc * 1.0;
    cyc_r = (res_r * 1.0 + res_g * cyw[0] + res_b * cyw[1] ) / (1.0 + (cyw[0]+cyw[1]));
    cyc_g = (res_r * cyw[3] + res_g * 1.0 + res_b * cyw[2] ) / (1.0 + (cyw[2]+cyw[3]));
    cyc_b = (res_r * cyw[4] + res_g * cyw[5] + res_b * 1.0 ) / (1.0 + (cyw[4]+cyw[5]));
    res_r = cyc_r;
