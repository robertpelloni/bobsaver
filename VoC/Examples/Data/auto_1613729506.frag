...
// ---- ---- ---- ---- ---- ---- ---- ----
    ...
    vec3 n10r = nhd( vec2(4.0, 1.0), psn, 0.0, 0, div );
    vec3 n11r = nhd( vec2(8.0, 3.0), psn, 0.0, 0, div );

    vec3 n20r = nhd( vec2(5.0, 0.0), psn, 0.0, 0, div );
    vec3 n21r = nhd( vec2(8.0, 3.0), psn, 0.0, 0, div );
    vec3 n30r = nhd( vec2(9.0, 4.0), psn, 0.0, 0, div );
    vec3 n31r = nhd( vec2(14.0, 8.0), psn, 0.0, 0, div );

    vec3 nmr = nhd( vec2(1.0, 0.0), psn, 0.0, 0, div );
...
// r1 = (r1 + (nmrw * 0.08) ) / 1.08;
    r0 = (r0 + (n00rw * s) + (n01rw * s) + (res_r * 0.15)) / (1.15 + (s*2.0));
    r1 = (r1 + (n10rw * s) + (n11rw * s) + (res_r * 0.15)) / (1.15 + (s*2.0));
...
// r3 = (r3 + (nmrw * 0.08) ) / 1.08;
    r2 = (r2 + (n20rw * s) + (n21rw * s) + (res_r * 0.15)) / (1.15 + (s*2.0));
    r3 = (r3 + (n30rw * s) + (n31rw * s) + (res_r * 0.15)) / (1.15 + (s*2.0));
