...
// original https://www.shadertoy.com/view/fsBSRy
...
// The code is not meant to be read by humans :)
...
#define p_o5229_bevel 5.5/resolution.y
...
float o5271_0_d = max(o5271_0_wat.x,o5271_0_wat.y);vec4 o5271_0_1_rgba = o5271_gradient_gradient_fct(2.0*abs(fract(-0.2*time + p_o5271_repeat*o5271_0_d)-0.5));
...
#define p_o5268_bevel 5.5/resolution.y
