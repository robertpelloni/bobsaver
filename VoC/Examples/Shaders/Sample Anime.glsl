...
// original https://www.shadertoy.com/view/wlcyRN
...
vec3 filter_(vec3 color) {
  return color * 0.5 * (2.0 - gl_FragCoord.xy.x / resolution.x + gl_FragCoord.xy.y / resolution.y);
}
...
void main(void)
{
    ...
    glFragColor = vec4(filter_(col),  1.0); 
}
