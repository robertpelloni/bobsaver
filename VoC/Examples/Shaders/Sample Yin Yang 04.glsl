...
// original https://www.shadertoy.com/view/Msc3WB
...
void main(void)
{
    ...
    vec2 mouseRel = mouse*resolution.xy.xy/resolution.xy;
    
    float time = 2.5 + time * 0.5;
    ...
    vec3 rd = cam * rayDir( 45.0, resolution.xy, gl_FragCoord.xy );
