...
// original https://www.shadertoy.com/view/lljBzK
...
float cloud(in vec3 p)
{
    ...
    return 0.01f*fbm(0.9f*vec3(0.2f, 0.2f, 0.3f)*(p+vec3(0.0f, 0.0f, 3.0f*time)), 7, 0.5f, 4.0f);
}
...
void main(void)
{
    vec2 ndc = 2.0f*gl_FragCoord.xy / resolution.xy-1.0f;
