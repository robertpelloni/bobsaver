...
// original https://www.shadertoy.com/view/XtSGWD
...
void main(void) {
    ...
    for (int i = 0; i < buildingCount; ++i) {
        ...
        float time = (time - buildingScale * id) / buildingLifeTime + 1.0;
        ...
        float char2 = 1.5 + 4.0 * noise12(id + 6.0 * charPos);
        ...
        char2 *= step(outline, 0.001);
        signColor = mix(backgroundFog * time, signColor, clamp(char2, 0.0, 1.0));
