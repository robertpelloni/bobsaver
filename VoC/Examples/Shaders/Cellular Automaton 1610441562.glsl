...
void main() {
    ...
    float nh0s = 14.0;
    vec3 nh0 = nh_ring ( nh0s, 0.0, vec2( 0.28, 3.88 ), vec2(0.0, 0.0) );
    float nh0c = nh0[0] / nh0[1];
        if( nh0c >= 0.379 && nh0c <= 0.490 ) { res = 1.0; }
        if( nh0c >= 0.526 && nh0c <= 0.768 ) { res = 0.0; }
        if( nh0c >= 0.209 && nh0c <= 0.254 ) { res = 0.0; }
        if( nh0c >= 0.206 && nh0c <= 0.210 ) { res = 1.0; }
        if( nh0c >= 0.321 && nh0c <= 0.334 ) { res = 0.0; }
        if( nh0c >= 0.129 && nh0c <= 0.138 ) { res = 1.0; }
