...
// vec2 nhr = nh_val ( 1.0, 0.0, 0 ); // Wobble Height
    vec2 nhr = vec2(cv,1.0);
    vec2 nhg = nh_val ( 1.0, 0.0, 1 ); // Sharpness
    vec2 nhb = nh_val ( 6.0, 5.0, 2 ); // Spacing (> nhg && >= nh[n])
    ...
    //rg0 = (rg0 < rb0) ? g0 : rg0;
    rd1g = (rr0 > rb0+cs*10.0) ? rd1g : nh1v;
