...
// original https://www.shadertoy.com/view/Wty3zV
...
void main(void)
{
    vec2 uv = (gl_FragCoord.xy-vec2(resolution.xy*0.5))/resolution.y;
    ...
    for (int i=0; i<ITERATIONS; i++) 
    {
        ...
        float seed = 1000.0*fract(3.1379136*floor(time*SPEED+offset));
        float time = fract(time*SPEED+offset);
