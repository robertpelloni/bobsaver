...
// original https://www.shadertoy.com/view/lls3Wf
...
//of it :) so I went this route and faked it.
...
void main(){
    ...
    vec3 ro,rd;
    float pathSlider;
    SetCamera(ro,rd,pathSlider,time*0.25,uv);
    vec4 scn=scene(ro,rd,pathSlider,time*0.25,3.0/resolution.y);
    glFragColor = vec4(scn.rgb,1.0);
}
