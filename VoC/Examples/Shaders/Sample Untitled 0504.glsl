...
// original https://www.shadertoy.com/view/wt3XR4
...
#define my (10.*mouse*resolution.xy.y/resolution.x)
...
void main(void)
{
    vec4 S = vec4(0.0); //texture(iChannel0, vec2(0.01,0.0));
    ...
    G += glowB*0.002 *pal(0.2, 0.6, vec3(0.8,0.4,0.7), 5.99 - sin(time), 2.4);
    G *= 1. + pow(S.x,5.)*0.2;
