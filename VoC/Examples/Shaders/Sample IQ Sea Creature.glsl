...
// original https://www.shadertoy.com/view/csB3zy
...
void main(void)
{
    ...
    col += fract(sin(gl_FragCoord.xy.x*vec3(13,1,11)+gl_FragCoord.xy.y*vec3(1,7,5))*158.391832)/255.0;
