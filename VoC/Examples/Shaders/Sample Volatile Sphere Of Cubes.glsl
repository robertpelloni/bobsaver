...
// original https://www.shadertoy.com/view/MdlBW7
...
float Scene( vec3 p )
{
    ...
    for ( float i = -5.0; i < 6.0; ++i )
    {
        ...
        vec3 t = p;        
        float boxLen = 0.15 + sin( time * 2.0 ) * 0.1;        
...
void main(void)
{
    ...
    else
    {
        ...
        if ( planeT > 0.0 )
        {
            ...
            float radius = max( 0.15 + sin( time * 2.0 ) * 0.1, 0.15 + sin( time * 3.0 ) * 0.1 );
