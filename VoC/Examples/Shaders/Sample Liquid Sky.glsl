...
const vec3 skycolour1 = vec3(0.8, 0.4, 0.6);
const vec3 skycolour2 = vec3(0.4, 0.7, 2.0);
...
void main(void) {
    ...
    vec3 cloudcolour = vec3(9.10, 1.1, 0.9) * clamp((clouddark + cloudlight*c), 0.0, 1.0);
