...
void main() {
    ...
    **/
    ...
    //zoomed x4 parameters
    vec3 nr0 = nhd( vec2(1.0,0.0), psn, 0.0, 0, div );
    vec3 nr1 = nhd( vec2(2.0,0.0), psn, 0.0, 0, div );
    vec3 nr2 = nhd( vec2(16.0,4.0), psn, 0.0, 0, div );
    vec3 nr3 = nhd( vec2(28.0,8.0), psn, 0.0, 0, div );
    vec3 nr4 = nhd( vec2(48.0,16.0), psn, 0.0, 0, div );
    vec3 nr5 = nhd( vec2(80.0,28.0), psn, 0.0, 0, div );
    vec3 nr6 = nhd( vec2(132.0,48.0), psn, 0.0, 0, div );
    vec3 nr7 = nhd( vec2(216.0,80.0), psn, 0.0, 0, div );
    vec3 nr8 = nhd( vec2(348.0,132.0), psn, 0.0, 0, div );
