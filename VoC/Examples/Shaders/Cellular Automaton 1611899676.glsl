...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.270 && nhdr0_avg <= 0.320) { r0 += 0.120; res_g = 1.0; }
    if( nhdr0_avg >= 0.420 && nhdr0_avg <= 0.540) { r0 += 0.120; res_g = 0.5; }

    if( nhdr0_avg >= 0.140 && nhdr0_avg <= 0.185+cs ) { r0 -= 0.180; res_b = 1.0; }
    if( nhdr0_avg >= 0.330 && nhdr0_avg <= 0.560 ) { r0 -= 0.080; res_b = 0.7; }
    if( nhdr0_avg >= 0.620 && nhdr0_avg <= 0.680 ) { r0 -= 0.380; res_b = 0.3; }
