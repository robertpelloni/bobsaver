...
// original https://www.shadertoy.com/view/4sB3Dt
...
void InitIFS() {
    ...
    ifs_lerp.transform[0] = vec4(0.0);
    ifs_lerp.transform[1] = vec4(0.0);
    ifs_lerp.transform[2] = vec4(0.0);
    ifs_lerp.transform[3] = vec4(0.0);
