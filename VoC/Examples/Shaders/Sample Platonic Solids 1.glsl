...
// original https://www.shadertoy.com/view/Md3SDB
 ...
 *
 * From my side: added glow, tetrahedron and normalized size of the solids to be closed inside
...
const float GlowDistance = 0.36974;
