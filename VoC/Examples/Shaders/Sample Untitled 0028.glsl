...
void main(void) {    
    ...
    if (distance > 0.0) {
        ...
        // Ambient,
        glFragColor += ambientColor;
        
        // Fog,
        glFragColor = mix(glFragColor, fogColor, min(distance-1.0, 3.0)/3.0);
    } else {
        glFragColor = fogColor;
    }
