...
vec3 PostEffects(vec3 rgb, vec2 xy)
{
    ...
    // Vignette...
    rgb *= .5+0.5*pow(40.0*xy.x*xy.y*(1.0-xy.x)*(1.0-xy.y), 0.2 );    
    return (rgb);
}
// map
...
void main( void ) {
    ...
    vec3 col = vec3(0.6,0.65,0.85) - rd.y*0.2*vec3(1.0,0.5,1.0) + 0.17*0.5;
    col += vec3(1.2,1.22,0.7)*sun * 0.2;
    col *= 0.95;
    
    col = mix( col, res.xyz, res.w );
    col += 0.2*vec3(0.645,0.4,0.2)*pow( sun, 3.0 );
    col *= col;
    col = col;
