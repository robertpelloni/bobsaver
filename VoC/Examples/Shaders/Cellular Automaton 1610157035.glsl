...
void main() {
    ...
    float nh0c = nh0[0] / nh0[1];
        if( nh0c >= 0.129 && nh0c <= 0.146 ) { res = 0.0; }
        if( nh0c >= 0.187 && nh0c <= 0.270 ) { res = 0.0; }
        if( nh0c >= 0.187 && nh0c <= 0.208 ) { res = 1.0; }
        if( nh0c >= 0.500 && nh0c <= 0.530+cs ) { res = 0.0; }
        if( nh0c >= 0.043 && nh0c <= 0.087 ) { res = 0.0; }

    float nh1s = 2.0;
    vec3 nh1 = nh_ring ( nh1s, 0.0, vec2(1.0, 0.0), vec2(0.0, 0.0) );
    float nh1c = nh1[0] / nh1[1];
        if( nh1c >= 0.501 && nh1c <= 0.700 ) { res = 1.0; }
        if( nh1c >= 0.800 && nh1c <= 0.831 ) { res = 0.0; }
