...
// original https://www.shadertoy.com/view/WtG3RD
...
void main(void)
{
    ...
    float s3 = (simplex_noise(vec3(vec2(am, am*100. + time*3.)*.15, 30. + time*.525))*(max(.0 + l*1., .25)) + 1.5);
    ...
    vec3 col = mix(BLACK_COL, (0.5 + 0.5*cos(time+uv.xyx*3.+vec3(0,2,4))), m);
