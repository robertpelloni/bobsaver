...
// original https://www.shadertoy.com/view/XlSGWR
...
void main(void) {
    ...
    float ms = -1.0+2.0*mouse.y/resolution.y;
    
    vec3 ro = vec3(5.0*cos(time), 0.0, 10.0);
    ...
    vec2 vig = gl_FragCoord.xy/resolution.xy;
