...
// original https://www.shadertoy.com/view/WlByD3
...
void main(void)
{
    ...
    if (length(mouse*resolution.xy.xy) > 40.0) {
        viewDir.yz *= rot(3.14*0*resolution.xy.y/resolution.y*3.14);
        viewDir.xz *= rot(3.14-0*resolution.xy.x/resolution.x*3.14*2.0);
    }
