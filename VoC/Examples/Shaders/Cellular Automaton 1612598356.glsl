...
/**/
    vec3 nr0 = nhd( vec2(1.0,0.0), psn, 0.0, 0 );
    vec3 nr1 = nhd( vec2(6.0,0.0), psn, 0.0, 0 );
    vec3 nr2 = nhd( vec2(18.0,0.0), psn, 0.0, 0 );
    vec3 nr3 = nhd( vec2(33.0,0.0), psn, 0.0, 0 );
    vec3 nr4 = nhd( vec2(72.0,0.0), psn, 0.0, 0 );
    vec3 nr5 = nhd( vec2(126.0,0.0), psn, 0.0, 0 );
/**/
