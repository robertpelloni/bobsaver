...
// original https://www.shadertoy.com/view/4s3XRB
...
void main(void)
{
    ...
    glFragColor.rgb = vec3(0.47,0.6,0.76) * lighting(p, ro, rd, 0.0001); 
    glFragColor.rgb = mix( glFragColor.rgb, vec3(0.5,0.49,0.72), 1.0-exp( -fogd*d*d ) ); 
}
