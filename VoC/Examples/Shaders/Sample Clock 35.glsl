...
// original https://www.shadertoy.com/view/csl3DS
...
#if GLOWPULSE
    color += vec3(1,0.2,0) * shade * noise((uv + vec2(time*.5)) * 2.5 + .5);// * 10.*(noise(uv.yx));
#endif
