...
// original https://www.shadertoy.com/view/XsBSRV
...
// Using a part of the "Star map shader" by morgan3d (the nebula function)
// https://www.shadertoy.com/view/4sBXzG as environment map and light sphere texture
...
Hit scene(vec3 p)
{
    float d, d1, d2, d3, d4, d5, f, v, e = 0.15;
    ...
    col = mix(MOUTH_COL, col, smoothstep(0.11, 0.28, d2-d1));
    d = smin(d1, d2, 0.24);
