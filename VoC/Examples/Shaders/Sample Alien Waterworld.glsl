...
// original https://www.shadertoy.com/view/WtXyW4
...
vec3 getColor(vec3 ro, vec3 rd) {
  ...
  if (id > 0.0) {
    ...
    col = seaCol;
    col = mix(vec3(1.15), col, exp(-17.0*(hih-0.25*loh)));
    col = mix(vec3(1.0), col, exp(-10.0*loh*(max(d-ud, 0.0))));
