...
const vec4 skycolour1 = vec4(0.2, 0.4, 0.6, 0.0);
const vec4 skycolour2 = vec4(0.4, 0.7, 1.0, 0.0);
...
void main() {
  ...
  // vec4 skycolour = vec4(0.0, 0.0, 0.0, 0.0);
    ...
    //result = mix(result, skycolour, abs((p.x - 0.5) * 2.0));
       //result = mix(result, skycolour, abs((p.y - 0.5) * 2.0));
