...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.000 && nhdr0_avg <= 1.000 ) { r0 -= 0.01; }
    if( nhdr0_avg >= 0.365 && nhdr0_avg <= 0.422 ) { r0 += 0.12; }
    if( nhdr0_avg >= 0.172 && nhdr0_avg <= 0.257 ) { r0 += 0.04; }
    if( nhdr0_avg >= 0.283 && nhdr0_avg <= 0.420+cs ) { r0 -= 0.09; }
    if( nhdr0_avg >= 0.130 && nhdr0_avg <= 0.190 ) { r0 -= 0.14; }
    if( nhdr0_avg >= 0.630 && nhdr0_avg <= 0.730 ) { r0 += 0.12; }
