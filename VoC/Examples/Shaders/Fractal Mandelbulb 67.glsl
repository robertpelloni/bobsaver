...
// original https://www.shadertoy.com/view/slGSR3
 ...
 { 
    ...
    vec3 res = intersect(ro, rd);
     if(res.x > 0.0){
           ...
           vec3 tc0 = 0.5 + 0.5 * cos(-6.0*time + 9.2 * res.y + vec3(0.9, 0.0, 0.0));
    ...
    //col*=0.5+0.5*pow(16.0*q.x*q.y*(1.0-q.x)*(1.0-q.y),0.7);  // vigneting
     glFragColor = vec4(col.xyz, smoothstep(0.55, .76, 1.-res.x/5.)); 
 }
