...
// original https://www.shadertoy.com/view/MtjyWm
...
void main(void)
{
    ...
    if (d<dMax)
    {
        ...
        vec3 tex = vec3(0.0); //texture(iChannel0, mat.yz).rgb; // wood
        ...
        glFragColor.rgb = mix( glFragColor.rgb, sky, 1.0-exp( -0.01*d*d*count/150. ) ); 
    }
    else
    {
        glFragColor.rgb = sky;
    ...
    glFragColor.rgb = sqrt(glFragColor.rgb * glFragColor.rgb * 0.8);
}
