...
//original https://www.shadertoy.com/view/4s23Rh
...
void main() {
    ...
    vec3 rd=lookat(vec3(1.0+sin(tim*1.6)*0.5,-ro.y*2.0+3.5,0.7),vec3(0.0,1.0,0.0))*normalize(vec3((2.0*gl_FragCoord.xy-size.xy)/size.y,1.0));
