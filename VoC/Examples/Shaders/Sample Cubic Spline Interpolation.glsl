...
// original https://www.shadertoy.com/view/MdcBzB
...
#ifdef GLSLSANDBOX
void main() {
void main(void) //WARNING - variables     (gl_glFragColor, gl_gl_FragCoord.xy); need changing to glFragColor and gl_FragCoord
}
#endif
