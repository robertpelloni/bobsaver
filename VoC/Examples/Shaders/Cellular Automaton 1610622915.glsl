...
vec2 nh_val(float nhsz, float rnsz, int col, vec2 sinmod) {
    float nhsz_c = 0.0;
    float val = 0.0;
    float nh_val = 0.0;
    float cval = 0.0;
...
void main() {
    ...
    float cs = 1.0*0.01;
    vec2 sm = vec2(1.0,1.0);

    float c0 = gv(0.0,0.0,0);

    vec2 nh0 = nh_val ( 1.0, 0.0, 0, sm );
    vec2 nh1 = nh_val ( 3.0, 1.0, 0, sm );
    vec2 nh2 = nh_val ( 5.0, 4.0, 0, sm );

    float nh0v = (nh0[0] / nh0[1])*(1.05);
    float nh1v = (nh1[0] / nh1[1])*(1.05);
    float nh2v = (nh2[0] / nh2[1])*(1.05);
