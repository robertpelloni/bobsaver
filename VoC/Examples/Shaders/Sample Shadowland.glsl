...
// original https://www.shadertoy.com/view/ltyfDm
...
vec3 color(vec3 ro, vec3 rd, vec3 norm, vec3 lp, float t, float md)
{
    ...
    // I dont think the scene really "needs" the fresnel but Im using anyway
    // BTW I learned both the amb and fre from iq's examples
...
void main(void)
{
    ...
    //vec3 lp = ro + vec3(1.0, 0.7, sin(time) * 3.0);
