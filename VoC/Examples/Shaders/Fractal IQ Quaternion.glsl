...
void main(void)
{
    ...
    float r = 1.4+0.15*cos(0.0+0.29*time2);
    vec3 campos = vec3(           r*cos(0.3+0.37*time2), 
                        0.3 + 0.8*r*cos(1.0+0.33*time2), 
                                  r*cos(2.2+0.31*time2) );
    vec3 camtar = vec3(0.0,0.0,0.0);

    float roll = 0.1*cos(0.1*time2);
    ...
    vec4 cc = vec4( 0.4*cos(0.5+1.2*time2)-.3, 
                    0.4*cos(3.9+1.7*time2), 
                    0.4*cos(1.4+1.3*time2),
                    0.4*cos(1.1+2.5*time2));
