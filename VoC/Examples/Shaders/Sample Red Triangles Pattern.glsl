...
void main(void) {
  ...
  float angle = 1.0+time+10.0*sin(1.0*pcenter.y+1.0*time)*sin(1.0*pcenter.x+1.0*time);
  angle = angle;
  ...
  float m = 0.5+0.5*sin(123.0*pcenter.x+5587.0*pcenter.y+3.0*time);
  glFragColor = vec4(m*f,0.0,0.0,1.0);
}
