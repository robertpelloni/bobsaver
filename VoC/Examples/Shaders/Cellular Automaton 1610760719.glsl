...
void main() {
    ...
    vec2 nhg = nh_val ( 6.0, 5.0, 1 );
    vec2 nhb = nh_val ( 12.0, 11.0, 2 );
    ...
    float rd1b = clamp( (nh1v * (2.0)) - nhbv ,0.0,1.0);
    float rdb1 = clamp( (nhbv * (2.0)) - nh1v ,0.0,1.0);
    float rdr1b = (nh1[1]<nhb[1]) ? rd1b : rdb1;
