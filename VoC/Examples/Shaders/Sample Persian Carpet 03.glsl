...
// original https://www.shadertoy.com/view/Nd3GWH
...
void main(void)
{
    ...
    //vec3 random1 = hash31(floor((time)/10.0))*10.;
    float t2 = floor((time+25.)/20.0+uv.x);
    vec3 random1 = 4.-hash31(t2)*8.;
