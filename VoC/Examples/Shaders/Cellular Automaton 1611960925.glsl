...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.196 && nhdr0_avg <= 0.270) { r0 += 0.03; }

    if( nhdr0_avg >= 0.000 && nhdr0_avg <= 0.084 ) { r0 -= 0.03; }
    if( nhdr0_avg >= 0.085 && nhdr0_avg <= 0.192 ) { r0 -= 0.03; res_b = 1.0; }
    if( nhdr0_avg >= 0.222 && nhdr0_avg <= 0.295+cs ) { r0 -= 0.03; res_g = 0.5; }
    if( nhdr0_avg >= 0.365 && nhdr0_avg <= 1.000 ) { r0 -= 0.01; res_g = 1.0; }
