...
// original https://www.shadertoy.com/view/3scyR4
...
// Modification of Echeveria by tdhooper 
...
void main(void) {
    ...
    time2 = mTime - 0.1*(1.0/24.0)*(float(m*AA+n)+d)/float(AA*AA-1);
    #endif
        lightingPass = false;
