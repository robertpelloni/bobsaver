...
// original https://www.shadertoy.com/view/Xs3Gzf
...
void main(void)
{
    ...
    vec2 m = vec2(0.0, -0.5);// mouse*resolution.xy.xy/resolution.xy;
    ...
    glFragColor = trace_spheres( ro + vec3(0.5, 1.5, 0.0), rd );
}

void mainVR( out vec4 glFragColor, in vec2 gl_FragCoord, in vec3 fragRayOri, in vec3 fragRayDir )
{
    glFragColor = trace_spheres( fragRayOri, fragRayDir );
}
