...
// original https://www.shadertoy.com/view/NttBW8
...
void main(void)
{
    ...
    for (float frame = 0.; frame < frames; ++frame)
    {
        ...
        vec2 p = 2.*(gl_FragCoord.xy-R.xy/2.)/R.y;
        ...
        vec3 rng = hash(uvec3(gl_FragCoord.xy, float(frames) + frame*196.));
