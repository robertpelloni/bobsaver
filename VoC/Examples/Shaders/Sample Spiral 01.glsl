...
// original https://www.shadertoy.com/view/lssXzs
...
void main(void)
{
    float Ratio = 0.45*min(resolution.x, resolution.y);
    ...
    for(float F=0.0; F<AaCount; F++)
    {
        ...
        vec2 UV = (gl_FragCoord.xy  + Off - resolution.xy/2.0) / Ratio;    
