...
// original https://www.shadertoy.com/view/Mss3R8
...
{
    #if 1
    float scol = calc( gl_FragCoord.xy/resolution.xy, time );
    #else
    float scol = 0.0;
    float h = 0.0;
    ...
    for( int i=0; i<NumSamples; i++ )
    {
        ...
        scol += calc( (gl_FragCoord.xy+of)/resolution.xy, time - h*0.4/24.0 );
        h += iSamples;
    }
    scol *= iSamples;
    #endif
