...
// original https://www.shadertoy.com/view/XllGzN
...
void main(void)
{
    ...
    for (int r=0; r<volsteps; r++) {
        ...
        for (int i=0; i<iterations; i++) { 
            ...
            a += i > 7 ? min( 12.,abs(length(p)-pa)) : abs(length(p)-pa); // absolute sum of average change
            pa=length(p);
        }
