...
// original https://www.shadertoy.com/view/MsK3zV
...
void main(void)
{
    ...
    uv = floor(uv * resolution.y);
    uv.x = mod(uv.x, resolution.x * WAVE_SIZE / res.x);
    ...
    for(int i = 0;i < 3;i++)
    {
        ...
        {
            float d = floor(n / pow(10.0, float(2-i)));
