...
void main(void) {
    ...
    if (b)    glFragColor = vec4(0.0, 1.0, 0.0, 1.0);
    else glFragColor = vec4(0.0, 0.0, 0.0, 1.0);
    
    if (mod(gl_FragCoord.y, 2.0) < 1.0) glFragColor *= 0.5;                        
    if (mod(uv.x, 4.0) < 2.0) glFragColor *= 0.65;        
}
