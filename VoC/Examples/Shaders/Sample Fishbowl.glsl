...
// original https://www.shadertoy.com/view/MlSSDR
...
int idObj;
mat3 fishMat, vuMat;
vec3 fishPos, qHit=vec3(0.0), sunDir, waterDisp, cloudDisp;
...
void main(void)
{
  vec2 canvas = resolution.xy;
  vec2 uv = 2. * gl_FragCoord.xy / canvas - 1.;
  uv.x *= canvas.x / canvas.y;
  tCur = time;
  vec3 mPtr = vec3(0.0,0.0,0.0);
