...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.193+cs && nhdr0_avg <= 0.271+cs ) { r0 += 0.03; }

    if( nhdr0_avg >= 0.000 && nhdr0_avg <= 0.134 ) { r0 -= 0.03; }
    if( nhdr0_avg >= 0.135 && nhdr0_avg <= 0.199 ) { r0 -= 0.03; res_b = 1.0; }
    if( nhdr0_avg >= 0.226 && nhdr0_avg <= 0.298 ) { r0 -= 0.03; res_g = 0.3; }
    if( nhdr0_avg >= 0.332 && nhdr0_avg <= 0.850 ) { r0 -= 0.01; res_g = 0.6; }
    if( nhdr0_avg >= 0.385 && nhdr0_avg <= 0.435 ) { r0 -= 0.01; res_g = 1.0; }

    if(r0 >= 0.0 && res_g <= 0.0) { res_g = r0; }
    if(r0 >= 0.0 && res_b <= 0.0) { res_b = r0; }
