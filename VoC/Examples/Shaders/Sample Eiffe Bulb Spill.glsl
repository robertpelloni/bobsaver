...
//original https://www.shadertoy.com/view/ldjGWz
...
void main() {
    ...
    vec3 rd=lookat(vec3(2.0,-1.0,0.0),vec3(0.0,1.0,0.0))*normalize(vec3((2.0*gl_FragCoord.xy-size.xy)/size.y,2.0));
    ...
    glFragColor = vec4(clamp(col.rgb*2.5,0.0,1.0),1.0);
}
