...
// original https://www.shadertoy.com/view/3dXyWj
...
void main(void) {
    ...
    vec2 coord0 = primary_gl_FragCoord.xy+primary_center;
    vec2 coord1 = rotateOrigin(rotated_gl_FragCoord.xy, rotated_center, time/u_rot_left_divisor);
    vec2 coord2 = rotateOrigin(rotated_gl_FragCoord.xy, rotated_center, time/u_rot_right_divisor);
