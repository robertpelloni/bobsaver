...
// original https://www.shadertoy.com/view/wlG3Rd
...
void main(void) {
  vec2 uv =  SCALE * gl_FragCoord.xy / resolution.y;

  float noise_fac = noise(uv, SCALE_TIME * 2.0 * M_PI * time);
  ...
  glFragColor = vec4(color * clip, 1.0);
}
