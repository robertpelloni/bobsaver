...
// Cyclic Diffusion Values : cd[c0][c1][c2]v
    ...
    // ( nri, nbi )
    float tnncrcb = tur( nhcrv, nhcbv );
    float tnncrvb = tur( nhcrv, nhvbv );
    float tnncr0b = tur( nhcrv, nh0bv );
    float tnncr1b = tur( nhcrv, nh1bv );
    float tnncr2b = tur( nhcrv, nh2bv );
    float tnncr3b = tur( nhcrv, nh3bv );
    float tnncr4b = tur( nhcrv, nh4bv );
    float tnnvrcb = tur( nhvrv, nhcbv );
    float tnnvrvb = tur( nhvrv, nhvbv );
    float tnnvr0b = tur( nhvrv, nh0bv );
    float tnnvr1b = tur( nhvrv, nh1bv );
    float tnnvr2b = tur( nhvrv, nh2bv );
    float tnnvr3b = tur( nhvrv, nh3bv );
    float tnnvr4b = tur( nhvrv, nh4bv );
    float tnn0rcb = tur( nh0rv, nhcbv );
    float tnn0rvb = tur( nh0rv, nhvbv );
    float tnn0r0b = tur( nh0rv, nh0bv );
    float tnn0r1b = tur( nh0rv, nh1bv );
    float tnn0r2b = tur( nh0rv, nh2bv );
    float tnn0r3b = tur( nh0rv, nh3bv );
    float tnn0r4b = tur( nh0rv, nh4bv );
    float tnn1rcb = tur( nh1rv, nhcbv );
    float tnn1rvb = tur( nh1rv, nhvbv );
    float tnn1r0b = tur( nh1rv, nh0bv );
    float tnn1r1b = tur( nh1rv, nh1bv );
    float tnn1r2b = tur( nh1rv, nh2bv );
    float tnn1r3b = tur( nh1rv, nh3bv );
    float tnn1r4b = tur( nh1rv, nh4bv );
    float tnn2rcb = tur( nh2rv, nhcbv );
    float tnn2rvb = tur( nh2rv, nhvbv );
    float tnn2r0b = tur( nh2rv, nh0bv );
    float tnn2r1b = tur( nh2rv, nh1bv );
    float tnn2r2b = tur( nh2rv, nh2bv );
    float tnn2r3b = tur( nh2rv, nh3bv );
    float tnn2r4b = tur( nh2rv, nh4bv );
    float tnn3rcb = tur( nh3rv, nhcbv );
    float tnn3rvb = tur( nh3rv, nhvbv );
    float tnn3r0b = tur( nh3rv, nh0bv );
    float tnn3r1b = tur( nh3rv, nh1bv );
    float tnn3r2b = tur( nh3rv, nh2bv );
    float tnn3r3b = tur( nh3rv, nh3bv );
    float tnn3r4b = tur( nh3rv, nh4bv );
    float tnn4rcb = tur( nh4rv, nhcbv );
    float tnn4rvb = tur( nh4rv, nhvbv );
    float tnn4r0b = tur( nh4rv, nh0bv );
    float tnn4r1b = tur( nh4rv, nh1bv );
    float tnn4r2b = tur( nh4rv, nh2bv );
    float tnn4r3b = tur( nh4rv, nh3bv );
    float tnn4r4b = tur( nh4rv, nh4bv );
...
/**/
    ...
    rw = sqrt(sqrt(tnn0r2r*tnn2r4r)*tnn0r2r);
    rw = tur( tnn2r4r, tnn0r2r );
    rw = (tnn0r2r < tnn2r4r) ? tnn0r2r : tnn2r4r;
    rw = (tnn0r2r > tnn2r4r) ? tnn0r2r : tnn2r4r;
    rw = (tnn0r2r * 0.5) + ((1.0-abs(tnn0r2r-tnn2r4r)) * 0.5); // Rating: 0.3
    rw = (tnn0r2r * 1.0) - ((1.0-abs(tnn0r2r-tnn2r4r)) * 0.5); // Rating: 0.1
    rw = (tnn0r2r * 1.0) - ((0.5-abs(tnn0r2r-tnn2r4r)) * 1.0); // Rating: 0.4
    rw = (tnn0r2r * 1.0) - ((0.5-abs(tnn0r2r-tnn2r4r)) * 0.5); // Rating: 0.6
    rw = (tnn0r2r * 1.0) - ((0.5-abs(tnn0r2r-tnn2r4r)) * 2.0); // Rating: 0.4
    rw = (tnn0r2r * 2.0) - ((0.5-abs(tnn0r2r-tnn2r4r)) * 2.0); // Rating: 0.8
    rw = (tnn0r2r * 2.0) - ((0.5-abs(tnn0r2r-tnn2r4r)) * 1.0); // Rating: 0.2
    rw = (tnn0r2r * tnn2r4r) / abs(tnn0r2r-tnn2r4r);
    rw = (tnn0r2r - tnn2r4r) / (tnn0r2r + tnn2r4r);
    rw = pow(tnn2r4r, 3.0/10.0 ) * pow(tnn0r2r, 7.0/10.0 );

    float d0 = abs(nhcrv-tnn0r2r);
    float d1 = abs(nhcrv-tnn2r4r);
    float d2 = abs(tnn0r2r-tnn2r4r);

    rw = (d0 < d1) ? tnn0r2r : tnn2r4r;
    rw = (d0 > d1) ? tnn0r2r : tnn2r4r;

// rw = (d0 < d2) ? tnn0r2r : tnn2r4r;
// rw = (d0 > d2) ? tnn0r2r : tnn2r4r;
// rw = (d1 < d2) ? tnn0r2r : tnn2r4r;
// rw = (d1 > d2) ? tnn0r2r : tnn2r4r;

// rw = (d0 < d2) ? tnn2r4r : tnn0r2r;
// rw = (d0 > d2) ? tnn2r4r : tnn0r2r;
// rw = (d1 < d2) ? tnn2r4r : tnn0r2r;
// rw = (d1 > d2) ? tnn2r4r : tnn0r2r;

// rw = (tnn2r4r*3.0 + tnn0r2r*7.0) / 10.0; // just neat
// rw = (atan(sqrt(sqrt(tnn0r2r*tnn2r4r)*tnn0r2r)))*(1.0+cs); // Normalises results
// rw = (tnn0r2r*(0.1+cs)+nhcrv)/(1.1+cs); // Affects growth speed
