...
// original https://www.shadertoy.com/view/DsX3Rj
...
vec3 centerGraphic(vec2 p, vec3 col){
    ...
    float deg = -40.;
    float speed0 = -time*30.;
    float speed1 = time*20.;
    float speed2 = -time*10.;
    float speed3 = time*15.;
    float speed4 = time*25.;
