...
// original https://www.shadertoy.com/view/3tXfR4
...
{
    p*= objRot;
    return colornoise(p*objRot*2.,time*0.2, 0.8);
}
...
void main(void)
{
    ...
    //initialize globals
    objRot = rot3Dmat(vec3(-0.5,time*0.3,0.));
    ...
    // Output to screen
    glFragColor = mix(vec4(0.25,0.4,0.45,1.),vec4(color, 1.0),float(res.y>-0.5));
}
