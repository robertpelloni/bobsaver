...
// original https://www.shadertoy.com/view/7sGSRd
...
void main(void)
{
    ...
    tot += (1.0/255.0)*fract(sin(gl_FragCoord.xy.x*7.0+17.0*gl_FragCoord.xy.y)*1.317);
