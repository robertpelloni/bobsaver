...
// original https://www.shadertoy.com/view/wdjXDw
...
Another flower, closer to the style of John Edmark's sculptures.

The code is inefficient (so much that I disabled AA by default), and lacks
documentation. If you want to play with code and understand the log-spherical
mapping, check out "Recursive Lotus" instead:
https://www.shadertoy.com/view/3d2Szm

Powerful graphics card? Change the AA to 2 or 3.
