...
void main() {
    ...
    vec3 nr2 = nhd( vec2(4.0,0.0), psn, 0.0, 0 );
    vec3 nr3 = nhd( vec2(8.0,0.0), psn, 0.0, 0 );
    vec3 nr4 = nhd( vec2(12.0,0.0), psn, 0.0, 0 );
    vec3 nr5 = nhd( vec2(18.0,0.0), psn, 0.0, 0 );
