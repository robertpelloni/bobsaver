...
/**/
    vec3 nr0 = nhd( vec2(1.0,0.0), psn, 0.0, 0 );
    vec3 nr1 = nhd( vec2(10.0,0.0), psn, 0.0, 0 );
    vec3 nr2 = nhd( vec2(24.0,0.0), psn, 0.0, 0 );
    vec3 nr3 = nhd( vec2(48.0,0.0), psn, 0.0, 0 );
    vec3 nr4 = nhd( vec2(96.0,0.0), psn, 0.0, 0 );
    vec3 nr5 = nhd( vec2(132.0,0.0), psn, 0.0, 0 );
/**/
/*
    vec3 nr0 = nhd( vec2(1.0,0.0), psn, 0.0, 0 );
