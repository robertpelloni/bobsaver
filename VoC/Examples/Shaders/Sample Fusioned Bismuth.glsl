...
// original https://www.shadertoy.com/view/Msscz7
...
#if SHADER_TOY == 0
uniform float time;
uniform vec2 mouse*resolution.xy;
uniform vec2 resolution.xy;
#endif
...
void main(void) {
    ...
    // fragment position
    vec2 uv = ( gl_FragCoord.xy * 2.0 - resolution.xy ) / min( resolution.xy.x, resolution.xy.y );
