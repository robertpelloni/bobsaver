...
// original https://www.shadertoy.com/view/4dl3zr
...
void main( void ) {
    mouse2 = vec2(mouse.x / resolution.x, mouse.y / resolution.y);

    float waveHeight = USE_MOUSE ? mouse2.x * 5.0 : cos(time * 0.03) * 1.2 + 1.6;
    ...
    float middayperc = USE_MOUSE ? mouse2.y * 0.3 - 0.15 : max(0.0, sin(subtime));
