...
// original https://www.shadertoy.com/view/mdtXW7
...
out vec4 glFragColor;
 ...
 // created by dr2    https://www.shadertoy.com/view/ldScDt
...
#ifdef startinlake
    #define time mod(time*.83+120.,200.)
#else
    #define time mod(time*.83,200.)
#endif
