...
void main(void) 
{
    ...
    vec4 source = subPixel(backbuffer, gl_FragCoord.xy + vec2((gl_FragCoord.y - resolution.y / 2.0) / (gl_FragCoord.x - resolution.x / 2.0),(gl_FragCoord.x - resolution.x / 2.0) / (gl_FragCoord.y - resolution.y / 2.0)));
