...
// original https://www.shadertoy.com/view/lt2SzG
...
void main(void)
{
    float2 uv = gl_FragCoord.xy /100.0;
    float a1=0.0;
    float a2=0.0;
    ...
    float a0=a;
    a=cos((a*6.0-v0*v0*30.0+time*2.0)*pi)*0.5+0.5;
    ...
    glFragColor = float4(mix(col*(1.0-v0*v0*60.0),bak,v),1.0);
//    glFragColor = float4(bak,1.0);
}
