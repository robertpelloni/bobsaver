...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.547+cs && nhdr0_avg <= 0.630 ) { r0 += 0.120; res_g = 0.5; }
    if( nhdr0_avg >= 0.250 && nhdr0_avg <= 0.300 ) { r0 += 0.120; }
    if( nhdr0_avg >= 0.000 && nhdr0_avg <= 0.250 ) { r0 -= 0.250; }
    if( nhdr0_avg >= 0.720 && nhdr0_avg <= 0.820 ) { r0 += 0.120; res_b = 1.0; }
    if( nhdr0_avg >= 0.700 && nhdr0_avg <= 1.000 ) { r0 -= 0.060; res_g = 1.0; }
