...
// original https://www.shadertoy.com/view/Ms33Dj
...
vec3 carPos[NCAR + 1], oPos, qHit=vec3(0.0);
float ti[6], tPer, ts, tCur, qFy=0.0, fLen, spDist, spRad, trWid, dstFar;
int carCv[NCAR], oCv, idObj=0, idObjGrp;
bool tracking, refMir, smSurf=false;
