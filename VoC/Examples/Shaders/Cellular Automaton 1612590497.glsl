...
void main() {
    ...
    vec3 nr3 = nhd( vec2(12.0,0.0), psn, 0.0, 0 );
    vec3 nr4 = nhd( vec2(28.0,0.0), psn, 0.0, 0 );
    vec3 nr5 = nhd( vec2(46.0,0.0), psn, 0.0, 0 );
...
// ardf[i+j*nc] = arrw[i] - arrw[j];
    ...
    for(int i = 0; i < nc*nc; i++) {
        if(abs(ardf[i]) < ardf[minvar0] && abs(ardf[i]) >= 0.005) { minvar0 = i; }
    }
    ...
    float[8] wt;
                wt[0] = 2.000*0.0;
                wt[7] = 0.512*(0.00+cs*10.0)+0.005*0.0;
                wt[6] = 0.256*(0.00+cs*10.0)+0.005*0.0;
                wt[5] = 0.128*(0.00+cs*10.0)+0.005*0.0;
                wt[4] = 0.064*(0.00+cs*10.0)+0.005*0.0;
                wt[3] = 0.032*(0.00+cs*10.0)+0.005*0.0;
                wt[2] = 0.016*(0.00+cs*10.0)+0.005*0.0;
                wt[1] = 0.008*(0.00+cs*10.0)+0.005*0.0;
