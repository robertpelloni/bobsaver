...
// original https://www.shadertoy.com/view/Msjczw
...
void main(void) 
{
    ...
    glFragColor.xyz += vec3(abs(sin(t+1.04+g)), abs(sin(t+2.09+g)), abs(sin(t+3.14+g)))*(1.-inter.y*.067515);
    glFragColor.xyz += h*.125;
    glFragColor.xyz *= (1.25-length(uv)*1.); // vignette
}
