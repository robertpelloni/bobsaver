...
// original https://www.shadertoy.com/view/4sVfWw
...
#define fancy_lighting
// fancy lightig variables
#define ambient 0.2
...
void main(void)
{
    ...
    if(i < steps)
    {
        ...
        glFragColor = vec4(color*(normal*0.25+0.75),1.0);
        ...
        glFragColor *= edge;
#else
        glFragColor = 1.0-(1.0-glFragColor)*edge;
#endif
