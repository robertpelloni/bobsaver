...
// original https://www.shadertoy.com/view/NdKXDm
...
void main(void)
{
    ...
    //ro.yz*=rot(1.0*(mouse*resolution.xy.y/resolution.y));
...

    {
        ...
        float fres = pow(abs(.7+dot(rd,n)),4.0);        
        ...
        +spec*0.3+fres*mix(al,vec3(1),0.7);
