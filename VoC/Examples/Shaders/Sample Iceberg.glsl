...
// original https://www.shadertoy.com/view/4tdSDX
...
// Output is RGB color.
vec3 RayTrace(in vec2 gl_FragCoord )
{
    fade = 1.0;
    ...
    // debugging camera
    float mx=-mouse*resolution.xy.x/resolution.x*PI*2.0;
    float my=mouse*resolution.xy.y/resolution.y*3.14*0.95 + PI/2.0;
