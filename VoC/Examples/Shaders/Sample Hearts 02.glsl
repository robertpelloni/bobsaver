...
// original https://www.shadertoy.com/view/4sccWr
...
// https://www.youtube.com/watch?v=lrMiME82Cuk&feature=youtu.be
...
void main(void)
{
    ...
    float mt = time;
    float fade = S(0., 5., mt)*S(252., 230., mt);
    glFragColor = col*fade;
}
