vec3 TriplexMultiplicationIkenagaTrig3Rule20955(in vec3 z,in vec3 p) {
     vec3 znew;
     ...
     znew.z=r1r2*-cos(theta1+theta2)*-cos(theta1+theta2);
     return znew;
}
...
if (firstiteration==1) {
	...
	znew2=TriplexMultiplicationIkenagaTrig3Rule20955(znew2,z);
	znew2=znew2-c;
	znew=znew+znew2;
	lastz=z;
	z=znew;
