...
// original https://www.shadertoy.com/view/Xs3Bzs
...
void main(void)
{
    ...
    vec2 mm = mouse*resolution.xy.xy/resolution.xy - 0.5;
    ...
    vec3 color = mix(vec3(0.0, 0.0, 0.00)/1.0, vec3(0.0, 0.0, 0.0), uv.y)*3.-0.52*sin(time/0.4)*0.1+0.2;
