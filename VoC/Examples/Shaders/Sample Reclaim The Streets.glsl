...
// original https://www.shadertoy.com/view/fdSGWw
...
// Winning shader made at Revision 2021 Shader Showdown,
// Semi-Final round against Flopine / Ohno! ^ X-Men ^ Zen ^ swyng
...
void main(void)
{
  ...
  glFragColor = vec4(pow(co+g*.2*mix(vec3(1.,.5,0.),vec3(1.),sin(t*5.)*.5-.2),vec3(.45)),1);
}
