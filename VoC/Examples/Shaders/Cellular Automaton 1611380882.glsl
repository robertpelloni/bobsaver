...
// res_r = a*((a*a+x)/(x*x+a));
    ...
    float res_c = (res_r + a*0.3)/1.3;
    float res_f = res_c;

    if(a >= 0.000 && a <= 1.000) { res_f -= 0.005; }
    if(a >= 0.000 && a <= 0.250) { res_f -= 0.014; }
    if(a >= 0.110 && a <= 0.200) { res_f -= 0.022; }
    if(a >= 0.378 && a <= 0.606) { res_f -= 0.142; }
    if(a >= 0.680 && a <= 1.000) { res_f -= 0.230; }
    if(a >= 0.290 && a <= 0.310) { res_f -= 0.018; }
    if(a >= 0.792 && a <= 0.906) { res_f -= 0.080; }
    if(a >= 0.760 && a <= 0.925) { res_f -= 0.050; }

    if(a >= 0.120 && a <= 0.175) { res_f += 0.050; }
    if(a >= 0.250 && a <= 0.300) { res_f += 0.048; }
    if(a >= 0.358 && a <= 0.612) { res_f += 0.018; }
    if(a >= 0.495 && a <= 0.805) { res_f += 0.120; }
    if(a >= 0.350 && a <= 0.727) { res_f += 0.050; }
    if(a >= 0.380 && a <= 0.427) { res_f += 0.350; }
    if(a >= 0.360+cs && a <= 0.508) { res_f -= 0.170; }
