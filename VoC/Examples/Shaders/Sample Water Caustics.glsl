...
// original https://www.shadertoy.com/view/wlc3zr
...
void main(void) {
    ...
    vec2 uv = gl_FragCoord.xy / max(resolution.x, resolution.y) * 8.0;
    ...
    noiseResult = bccNoiseDerivatives_PlaneFirst(X - noiseResult.xyz / 16.0);
