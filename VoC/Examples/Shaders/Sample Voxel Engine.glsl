...
// original https://www.shadertoy.com/view/4tlfDn
...
float setCamera(out vec3 eye, out vec3 center) {
    ...
    //if (mouse*resolution.xy.z > 0.0) m = mouse*resolution.xy.xy / resolution.xy;
...
void main(void) {
    ...
    glFragColor = vec4(mix(backgroundColor, light * color, hit), 1.0);
}
