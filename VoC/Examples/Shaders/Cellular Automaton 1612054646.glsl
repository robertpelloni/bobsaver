...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.193 && nhdr0_avg <= 0.271 ) { r0 += 0.03; }

    if( nhdr0_avg >= 0.000 && nhdr0_avg <= 0.124 ) { r0 -= 0.03; }
    if( nhdr0_avg >= 0.125 && nhdr0_avg <= 0.199 ) { r0 -= 0.03; res_b = 1.0; }
    if( nhdr0_avg >= 0.226 && nhdr0_avg <= 0.298 ) { r0 -= 0.03; res_g = 1.0; }
    if( nhdr0_avg >= 0.332 && nhdr0_avg <= 0.850 ) { r0 -= 0.01; res_g = 1.0; }
