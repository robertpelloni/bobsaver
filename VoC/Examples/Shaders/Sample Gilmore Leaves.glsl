...
// original https://www.shadertoy.com/view/MsdSWl
...
void main(void)
{
    ...
    vec2 uvs = vec2( gl_FragCoord.xy - 0.5*resolution.xy ) / min(resolution.x,resolution.y);
    ...
    glFragColor = vec4(hsv2rgb(tileHSV),1.0);
