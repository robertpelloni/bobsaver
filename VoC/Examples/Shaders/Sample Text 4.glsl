...
// original https://www.shadertoy.com/view/XtBSWz
...
{    
    ...
    r += print_number(time, pos + vec2(1,50), uv);
...
void main(void)
{
    vec2 uv = gl_FragCoord.xy / resolution.xy * SCREEN_SZ;
    glFragColor = vec4(vec3(1,0,0) * Text(uv),1);
}
