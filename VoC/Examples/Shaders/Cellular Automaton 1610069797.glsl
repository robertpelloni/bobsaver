...
void main() {
    ...
    float nh0w = nh0[2] / nh0[1];
        if( nh0c >= 0.000 && nh0c <= 0.380 ) { res = 0.0; }
        if( nh0c >= 0.450 && nh0c <= 0.690 ) { res = 1.0; }
// if( nh0c >= 0.140 && nh0c <= 0.180 ) { res = 1.0; }

    float nh2s = 2.0;
    vec3 nh2 = nh_ring ( nh2s, 0.0, vec2(1.0, 0.0), vec2(0.0, 0.0) );
    float nh2c = nh2[0] / nh2[1];
    float nh2w = nh2[2] / nh2[1];
        if( nh2c >= 0.000 && nh2c <= 0.150 ) { res = 0.0; }

    float nh1s = 4.0;
    vec3 nh1 = nh_ring ( nh1s, 0.0, vec2(0.5, 3.0), vec2(0.0, 0.0) );
    float nh1c = nh1[0] / nh1[1];
    float nh1w = nh1[2] / nh1[1];
        if( nh1c >= 0.445 && nh1c <= 1.000 ) { res = 0.0; }
        if( nh2c >= 0.600 && nh2c <= 0.950 ) { res = 1.0; }
    ...
    float nh3w = nh3[2] / nh3[1];
        ...
        if( nh3c >= 0.742 && nh3c <= 1.000 ) { res = 0.0; }
