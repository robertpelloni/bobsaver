...
// original https://www.shadertoy.com/view/wldXWr
...
void main(void)
{
    ...
    vec2 m = (mouse*resolution.xy.xy-.5*resolution.xy)/resolution.xy;
    ...
    bg *= mix(1., rays, .25*poleDist*(sin(t*.1)*.5+.5));
    col += bg;
