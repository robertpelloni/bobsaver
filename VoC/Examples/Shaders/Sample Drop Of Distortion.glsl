...
// original https://www.shadertoy.com/view/WdKXWt
...
void main(void)
{
  ...
  float backscale = 0.9+sin(tick(time2,2.3)*0.3 + time2*0.1)*0.4;
  ...
  if(scene == 2.0) {
    float di = fract(uv2.x*10.0-time2*0.8)-0.5;
