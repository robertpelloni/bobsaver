...
// original https://www.shadertoy.com/view/4lGcz1
...
void main(void)
{
    ...
    dir.xz = rotate(sin(time) * 0.3) * dir.xz;
    pos.xz = rotate(sin(time) * 0.3) * pos.xz;
    dir.xy = rotate(0.1 + sin(time * 0.7) * 0.1) * dir.xy;
    pos.xy = rotate(0.1 + sin(time * 0.7) * 0.1) * pos.xy;
