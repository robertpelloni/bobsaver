...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.270 && nhdr0_avg <= 0.320 ) { r0 += 0.120; res_g = 0.3; }
    if( nhdr0_avg >= 0.552 && nhdr0_avg <= 0.640 ) { r0 += 0.120; res_g = 0.6; }
    if( nhdr0_avg >= 0.720 && nhdr0_avg <= 0.820 ) { r0 += 0.120; res_g = 1.0; }

    if( nhdr0_avg >= 0.000+cs && nhdr0_avg <= 0.250 ) { r0 -= 0.250; res_b = 0.6; }
    if( nhdr0_avg >= 0.700 && nhdr0_avg <= 1.000 ) { r0 -= 0.060; res_b = 1.0; }
