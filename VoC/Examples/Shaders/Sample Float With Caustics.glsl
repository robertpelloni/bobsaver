...
// original https://www.shadertoy.com/view/MttBRS
...
vec3 Camera(vec2 px) {
    vec2 uv = px.xy / resolution.xy * 2. - 1.;    
    uv.x *= resolution.x / resolution.y;
    vec3 rayStart = vec3(3.5, 4.7, 6.);
    vec3 rayDirection = LookAt(rayStart, vec3(0, -1.5, 0), normalize(vec3(uv, -2.)));
