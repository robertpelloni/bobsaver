							...
							)
{
	...
	sphere1.pos = (double3)((double)x[0],(double)y[0],(double)z[0]);
	intersect_sphere(&sphere1, &camray, &t);
	
	//sphere1.pos = (double3)(1.0, 1.0, 3.0);
	sphere1.pos = (double3)((double)x[1],(double)y[1],(double)z[1]);
	intersect_sphere(&sphere1, &camray, &t);

	//sphere1.pos = (double3)(-1.0, -1.0, 3.0);
	sphere1.pos = (double3)((double)x[2],(double)y[2],(double)z[2]);
	intersect_sphere(&sphere1, &camray, &t);

	//sphere1.pos = (double3)(-1.0, 1.0, 3.0);
	sphere1.pos = (double3)((double)x[3],(double)y[3],(double)z[3]);
	intersect_sphere(&sphere1, &camray, &t);

	//sphere1.pos = (double3)(1.0, -1.0, 3.0);
	sphere1.pos = (double3)((double)x[4],(double)y[4],(double)z[4]);
	intersect_sphere(&sphere1, &camray, &t);
