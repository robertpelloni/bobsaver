...
// original https://www.shadertoy.com/view/ltj3D3
...
void main(void)
{
  ...
  float dst = dstMetaball(tex, vec2(0.5, 0.5), radius);
  ...
  glFragColor = vec4(pow(color, vec3(0.5)) - 0.5, 1.0);
}
