...
// original https://www.shadertoy.com/view/Msl3DM
...
vec3 shade(vec3 ray, vec3 dir, vec3 nml, float dist)
{
    ...
    col += exp(-dist * 0.9 - noise1(time * 2.0) * 0.5);
...
void main(void)
{
    ...
    dir.yz = rotate(dir.yz, sin(time * 0.7) * 0.5 + 0.5);
    dir.xz = rotate(dir.xz, sin(time * 0.2) * 0.5);
