...
// original https://www.shadertoy.com/view/4ddfDS
...
vec4 map(vec3 rp, vec3 rd) {
    ...
    //vec4 sound = texture(iChannel0, vec2(0.5) / resolution.xy);
...
void setupCamera(vec2 gl_FragCoord, inout vec3 ro, inout vec3 rd, inout vec3 lp) {
