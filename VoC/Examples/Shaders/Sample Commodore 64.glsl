...
void main()
{
    ...
    glFragColor = vec4(mix(vec3(0.), glFragColor.rgb, dtoa(distanceToVisibleArea, 200.)), 1.0);
        
    glFragColor.rgb *= vignetteAmt;
    ...
    glFragColor.rgb *= 1.0 + scanLineFX;
    glFragColor.rgb = clamp(glFragColor.rgb, 0.0, 1.0);
