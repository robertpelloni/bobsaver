...
// original https://www.shadertoy.com/view/4dSBzD
...
//////////////////////////////////////////////////////////////////////////////////
// Tetris Fractal Zoom - Copyright 2017 Frank Force
...
const float glyphMargin            = 0.5f;    // how much to center the glyph in each pixel
const int glyph[glyphSize*glyphCount] = int[]
(// glyph sheet
 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0100, 0x0000, 0x0110, 0x0110, 0x0010, 0x0100, 0x0000, 0x0100, 0x0000, 0x0100, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0100, 0x0000, 0x0110, 0x0110, 0x0010, 0x0100,   
 0x0000, 0x0110, 0x0010, 0x1000, 0x1100, 0x1100, 0x0100, 0x0110, 0x0010, 0x0100, 0x0110, 0x0110, 0x0100, 0x1100, 0x1110, 0x0110, 0x0000, 0x0110, 0x0010, 0x1000, 0x1100, 0x1100, 0x0100, 0x0110, 0x0010, 0x0100, 0x0110, 0x0110, 
 0x1111, 0x0110, 0x1110, 0x1110, 0x0110, 0x0110, 0x0100, 0x0110, 0x0010, 0x0100, 0x0100, 0x0010, 0x1110, 0x0100, 0x0100, 0x0100, 0x1111, 0x0110, 0x1110, 0x1110, 0x0110, 0x0110, 0x0100, 0x0110, 0x0010, 0x0100, 0x0100, 0x0010, 
...
vec2 InitUV(vec2 uv)
{
    ...
    float theta = (pi/2.0)*(float(iterations) + (4.0*max(timePercent-0.75, 0.0)));
    float c = cos(theta);
    float s = sin(theta);
