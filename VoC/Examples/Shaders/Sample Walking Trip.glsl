...
// original https://www.shadertoy.com/view/td3cW7
...
// - vertical bobbing at each step, so half the period.
//
...
//     observation of the chronophotography, plus natural knowledge 
//     of what happens when we walk (stuff like "when on the ground,
//     the foot is horizontal and moves at constant speed").
//
// ------------------------------------------------------------
