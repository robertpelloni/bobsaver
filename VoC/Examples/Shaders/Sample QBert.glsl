...
// original https://www.shadertoy.com/view/4sl3RH
...
vec3 LightCubes(vec3 pos, vec3 n)
{
    ...
    if (foundHit > 0.0) areaColour = HueGradient((floor((time2*.8/18.0))+foundHit)/4.23);
