...
// Blue: Spacing / (B >= nhr) && (B > nhg)
    ...
    vec2 nhg = vec2 ( cvg, 1.0 );
    vec2 nhb = vec2 ( cvb, 1.0 );

            nhr = nh_val ( floor(1.0+(cs*20.0)), floor(0.0+(cs*00.0)), 0 );
// nhg = nh_val ( floor(1.0+(cs*10.0)), floor(0.0+(cs*10.0)), 1 );
// nhb = nh_val ( floor(1.0+(cs*20.0)), floor(0.0+(cs*20.0)), 2 );
    ...
    float r0 = (cvr / ((nhr[1]+200.0)/200.0)) + (nhr[0] / (nhr[1]+200.0));
    float g0 = (cvg / ((nhg[1]+200.0)/200.0)) + (nhg[0] / (nhg[1]+200.0));
    float b0 = (cvb / ((nhb[1]+200.0)/200.0)) + (nhb[0] / (nhb[1]+200.0));
