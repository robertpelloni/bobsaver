...
// original https://www.shadertoy.com/view/ldSGDt
...
void main(void)
{
    vec2 pos = gl_FragCoord.xy / resolution.y - vec2(.4,0);
    vec3 col = vec3(0.);
    float year = date.x, time2 = date.a;
    float v; vec2 p;
    v = mod(year/1000.,10.); 
