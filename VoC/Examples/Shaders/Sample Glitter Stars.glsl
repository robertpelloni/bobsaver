...
// original https://www.shadertoy.com/view/Nst3zj
...
/**
    ...
    The subject matter isn't that amazing but was more just 
    working on the material - have a few versions of it so far...
    
    I've always loved that glitter / plastic of amusment and fair rides
    so this was me trying to learn that trick or even how it could be done
    as it has so many uses (snow/sand/glitter/sparkels)
    
    I found this shader here by @tachyonflux https://www.shadertoy.com/view/ll2fzt
    
    which had the basics using a texture to seed the noise, and to me close up still
    looked like wavy noise. So started to rework the functions a bit into a more
    versitile material with a voronoi pattern.
    
    @byt3_m3chanic | 08/29/21
    other texture/noise variation
    https://www.shadertoy.com/view/7sd3RB
