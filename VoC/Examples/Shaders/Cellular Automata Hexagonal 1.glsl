...
//Upper and lover limits for keep alive and birth rules.
const float lKeepAlive = 0.2; //Change this to 1.9 for another cool pattern. 
const float uKeepAlive = 2.2;
const float lBirth     = 1.4;
const float hBirth     = 2.0;
