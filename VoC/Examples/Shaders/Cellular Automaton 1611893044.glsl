...
// res_b = (res_b - fract(res_b) ) / psn;
    ...
    if( nhdr0_avg >= 0.560 && nhdr0_avg <= 0.630 ) { r0 += 0.120; }
    if( nhdr0_avg >= 0.250 && nhdr0_avg <= 0.300 ) { r0 += 0.120; }
    if( nhdr0_avg >= 0.000 && nhdr0_avg <= 0.250 ) { r0 -= 0.250; }
    if( nhdr0_avg >= 0.770+cs && nhdr0_avg <= 0.870+cs ) { r0 += 0.120; }
    if( nhdr0_avg >= 0.730 && nhdr0_avg <= 1.000 ) { r0 -= 0.060; res_g = 1.0; } else {res_g = r0;}
