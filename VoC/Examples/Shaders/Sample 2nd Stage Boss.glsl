...
////////////////////////////////////////////////////////////////
// 
// "2nd stage BOSS" by 0x4015 & YET11 - GLSL Sandbox port
...
void main()
{
    vec2 fc = (gl_FragCoord.xy / resolution) * vec2(1280.0, 720.0);
    vec2 sc = gl_FragCoord.xy / (resolution.x / 1280.0);
    u = time;
    ...
    h *= O(a, -.0015);
    glFragColor = vec4(pow(h / (abs(h) + 1.0), vec3(.45)), 1.0);
}
