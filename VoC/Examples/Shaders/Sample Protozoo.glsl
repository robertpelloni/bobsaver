...
// Derivative of https://www.shadertoy.com/view/MdSGDW

#define PI                3.14159265359
#define PIH                (PI/2.0)
#define PI2                (PI*2.0)
#define DRAW_RANGE        64.0
vec3    MOD_OFFSET        = vec3(8.0, 24.0, 14.0);
...
float PropulsionTime(float s, float offset)        {return time*16.0 + sin((time+offset*PI)*2.0 + PI*0.1)*s;}
