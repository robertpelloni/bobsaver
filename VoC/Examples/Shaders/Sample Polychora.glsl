...
// original https://www.shadertoy.com/view/MdsGDH
...
{
    RotAngle = time*0.0;
    U = 0.0*cos(time)*0.5+0.1;
    V =  0.2*sin(time*0.1)*0.5+0.2;
    W =  1.0*cos(time*1.2)*0.5+0.5;
    ...
    vec3 camPos = (12.0+2.0*sin(time*0.6))*vec3(cos(time*0.3),0.0,sin(time*0.3));
