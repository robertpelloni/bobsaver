...
// original https://www.shadertoy.com/view/lt2GRD
...
void main(void)
{
    ...
    vec2 rot = 6.2831 * (vec2(0.6 + time * 0.25, sin(time * 0.5) * 0.06) + vec2(1.0, 0.0) * (mouse.xy - resolution.xy * 0.25) / resolution.x);
