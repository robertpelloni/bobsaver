...
// original https://www.shadertoy.com/view/XtyBWt
...
void main(void)
{
    ...
    vec2 uv = (gl_FragCoord.xy / resolution.xy - 0.5) * vec2(ar, 1.0);
    vec3 ro = vec3(0.0, 4.0, -9.5);
    vec3 rd = normalize(vec3(uv, 1.0));
    //opRotate(ro.xz, (mouse*resolution.xy.x / resolution.x * 2.0 - 1.0) * 0.5);
    //opRotate(rd.xz, (mouse*resolution.xy.x / resolution.x * 2.0 - 1.0) * 0.5);
    opRotate(rd.yz, 0.4);
    opRotate(kDirLight.dir.xz, time * 1.5);
