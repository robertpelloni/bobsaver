							...
							)
{
	...
	const int num_cells = get_global_id(9);
	...
	/* create and initialise another sphere */
	struct Sphere sphere2;
	sphere2.radius = 0.8;
	sphere2.pos = (double3)(1.0, 1.0, 3.0);
	sphere2.color = (double3)(0.9, 0.3, 0.0);

	/* create and initialise another sphere */
	struct Sphere sphere3;
	sphere3.radius = 0.8;
	sphere3.pos = (double3)(-1.0, -1.0, 3.0);
	sphere3.color = (double3)(0.9, 0.3, 0.0);

	/* create and initialise another sphere */
	struct Sphere sphere4;
	sphere4.radius = 0.8;
	sphere4.pos = (double3)(-1.0, 1.0, 3.0);
	sphere4.color = (double3)(0.9, 0.3, 0.0);

	/* create and initialise another sphere */
	struct Sphere sphere5;
	sphere5.radius = 0.8;
	sphere5.pos = (double3)(1.0, -1.0, 3.0);
	sphere5.color = (double3)(0.9, 0.3, 0.0);

	/* intersect ray with sphere */
	double t = 100000;
	intersect_sphere(&sphere1, &camray, &t);
	intersect_sphere(&sphere2, &camray, &t);
	intersect_sphere(&sphere3, &camray, &t);
	intersect_sphere(&sphere4, &camray, &t);
	intersect_sphere(&sphere5, &camray, &t);
