...
float field(in vec3 p) {
    ...
    float strength = 10. + .5 * log(1.e-6 + fract(sin(time) * 4373.11));
    float accum = 0.;
    float prev = 0.;
    float tw = 0.;
...
void main()
{
    ...
    for (int r=0; r<volsteps; r++) {
        ...
        backCol2 += mix(.6, 1., v2) * vec3(0.20 * t3 * t3 * t3, 0.4 * t3 * t3, t3 * 0.7) * fade;
