...
double trapsize=0;
bool trapped=false;
const int orbitstyle=0;
const bool onlyshowtraps=false;
const int numpals=2;
const int samplepixels=2;
const int displaystyle=1;
const int maxiters=1024;
const double bailout=400;
const double zoomfactor=1;
uniform double ymax=2.163;
uniform double ymin=-2.163;
uniform double xmax=3.73625;
uniform double xmin=-3.73625;
