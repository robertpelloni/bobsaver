...
void main() {
    ...
    float nh0w = nh0[2] / nh0[1];
        if( nh0c >= 0.012 && nh0c <= 0.045 ) { res = 0.0; }
        if( nh0c >= 0.215 && nh0c <= 0.428 ) { res = 0.0; }
        if( nh0c >= 0.135 && nh0c <= 0.170 ) { res = 1.0; }
        if( nh0c >= 0.415 && nh0c <= 0.593 ) { res = 1.0; }
    ...
    float nh3w = nh3[2] / nh3[1];
        if( nh3c >= 0.650 && nh3c <= 1.000 ) { res = 0.0; }
        if( nh3c >= 0.408 && nh3c <= 0.508 ) { res = 0.0; }
        if( nh3c >= 0.158 && nh3c <= 0.198 ) { res = 0.0; }
        if( nh3c >= 0.000 && nh3c <= 0.008 ) { res = 0.0; }
