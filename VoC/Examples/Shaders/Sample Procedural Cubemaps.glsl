...
// original https://www.shadertoy.com/view/4d2XD1
...
{    
    ...
    //vec2 um = iMouse.xy / resolution.xy-.5;
    vec2 um = vec2(1.0,1.0);
    ...
    col *= sin(bp.y*450.*resolution.y+time*0.1)*0.04+1.;
    //col *= (texture2D(iChannel0,p*0.003*iResolution.x+fract(time)*vec2(51,100)).r-0.5)*.1+1.;
    #endif
    
    glFragColor = vec4(pow(col,vec3(0.7)), 1.0);
}
