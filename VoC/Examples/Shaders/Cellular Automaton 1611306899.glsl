...
// res_r = a*((a*a+x)/(x*x+a));
    ...
    float res_c = (res_r + a*0.1)/1.1;

    res_c -= 0.07+cs;
    if(a >= 0.100 && a <= 0.900) { res_c += 0.03; }
    if(a >= 0.150 && a <= 0.600) { res_c -= 0.01; }
    if(a >= 0.180 && a <= 0.400) { res_c += 0.04; }
    if(a >= 0.240 && a <= 0.300) { res_c += 0.04; }
    if(a >= 0.270 && a <= 0.290) { res_c += 0.04; }
    if(a >= 0.250 && a <= 0.500) { res_c -= 0.03; }
    if(a >= 0.050 && a <= 0.150) { res_c -= 0.03; }
    if(a >= 0.450 && a <= 0.650) { res_c -= 0.03; }
    if(a >= 0.350 && a <= 0.550) { res_c += 0.04; }
