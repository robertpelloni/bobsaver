...
// original https://www.shadertoy.com/view/tljyRR
...
/*
    ...
    // which I was informed was on based on the following:
    //
    ...
    // A beautiful example, and my reason for wantomg to make one of these.
    //
...
// N represents the number polygon vertices, and Q is the number of 
// adjacent polygons to each vertex withing the Poincare disc.
//
...
// for the weave patten to work... Why is a bit of a mystery to me. I'll 
...
void main(void) {
    ...
    //
    // By the way, it's possible to account for the warping slightly by pinching 
    // the local coordinates slightly to match the warped hyperbolic space. 
    // It's possible to usea cheap hacky method (see below), rather than the 
    // more advanced method suggested.
