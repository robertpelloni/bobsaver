...
// original https://www.shadertoy.com/view/XsVBWG
...
void main(void)
 {
    ...
    if (dis < radius) {
        ...
        float light = pow(planetCoord.x, 2.0*(sin(time*.1)+1.5));
        ...
        glFragColor = vec4(fresnel.rgb, 1);
        glFragColor *= texCoord.x * 2.;
    }
    else {
        // Render stars
        ...
        glFragColor = vec4(background + atmosphereColor * outter, 1);
    }
}
