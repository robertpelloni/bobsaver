...
**/
    ...
    //zoomed in x4 parameters
    vec3 nr0 = nhd( vec2(1.0,0.0), psn, 0.0, 0 );
    vec3 nr1 = nhd( vec2(8.0,4.0), psn, 0.0, 0 );
    vec3 nr2 = nhd( vec2(24.0,12.0), psn, 0.0, 0 );
    vec3 nr3 = nhd( vec2(44.0,24.0), psn, 0.0, 0 );
    vec3 nr4 = nhd( vec2(96.0,60.0), psn, 0.0, 0 );
    vec3 nr5 = nhd( vec2(168.0,140.0), psn, 0.0, 0 );
