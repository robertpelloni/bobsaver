...
void main() {
    ...
    float var01 = abs(nh0v-nh1v);
    float var02 = abs(nh0v-nh2v);
    float var03 = abs(nh0v-nh3v);
    float var12 = abs(nh1v-nh2v);
    float var13 = abs(nh1v-nh3v);
    float var23 = abs(nh2v-nh3v);

    float tip = (cv<rdr13) ? (rdr13*0.05) : ((rdr13*0.05)*-1.0);

    res_r = (res_r+tip)*1.01;
