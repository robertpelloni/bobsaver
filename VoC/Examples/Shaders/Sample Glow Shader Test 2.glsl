...
// original https://www.shadertoy.com/view/4dSfDK
...
vec3 color(float grad) {
    ...
    float m2 = 0.0;//mouse*resolution.xy.z < 0.0001 ? 0.15 : mouse*resolution.xy.y * 3.0 / resolution.y;
    grad =sqrt( grad);
...
void main(void) {
    ...
    float m1 = 0.0;//mouse*resolution.xy.z < 0.0001 ? 1.6 : mouse*resolution.xy.x * 5.0 / resolution.x;
