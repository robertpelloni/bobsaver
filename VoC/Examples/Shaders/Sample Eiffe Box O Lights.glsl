...
//original https://www.shadertoy.com/view/XslGWX
...
vec3 dc=vec3(0.0);//some wonderful globals with opaque names :)
float mld;
float HitDistance;
float L1,L2;
vec3 posL;
...
void main() {
    HitDistance=0.666/size.y;
    L1=cos(time*2.0)*0.3;
    L2=sin(time*2.0);
    posL=vec3(0.5+L1,0.5-L1,L2);//position of lights
