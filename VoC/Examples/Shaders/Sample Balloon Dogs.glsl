...
// original https://www.shadertoy.com/view/MdVfWw
...
void setupCamera(vec2 gl_FragCoord, inout vec3 ro, inout vec3 rd) {
...
void mainVR(out vec4 glFragColor, in vec2 gl_FragCoord, in vec3 fragRayOri, in vec3 fragRayDir) {    
    glFragColor = vec4(render(fragRayOri * 4. + vec3(0.0,1.0,1.5), fragRayDir), 1.0);
}
