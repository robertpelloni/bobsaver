...
// original https://www.shadertoy.com/view/3ll3zr
...
void main(void)
{
    ...
    vec3 h = max(max(hearts(polar, time * speed, fft), 
                     hearts(polar, time * speed * 0.3 + 3., fft)), 
                 hearts(polar, time * speed * .2 + 5., fft));
