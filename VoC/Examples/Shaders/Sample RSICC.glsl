...
Material blueMaterial =     Material ( vec3(0.0, 0.0, 0.0), vec3(0.0,1.0,1.0), vec3(1.0,1.0,1.0), vec3(1.0,1.0,1.0), vec3(0.0,0.0,0.0), 0.5, 0.0, 40.0, 1.0 );
...
Material blackMaterial =     Material ( vec3(0.0, 0.0, 0.0), vec3(0.1,0.1,0.1), vec3(0.1,0.1,0.1), vec3(0.1,0.1,0.1), vec3(0.5,0.5,0.5), 0.1, 0.1, 1.0, 1.0 );
...
Material mirrorMaterial =     Material ( vec3(0.0, 0.0, 0.0), vec3(0.2,0.2,0.2), vec3(1.0,1.0,1.0), vec3(1.0,1.0,1.0), vec3(0.0,0.0,0.0), 1.0, 0.9, 40.0, 1.0 );
...
void main( void ) {
    ...
    glFragColor = vec4(recurseRay(ray),1.0);
}
