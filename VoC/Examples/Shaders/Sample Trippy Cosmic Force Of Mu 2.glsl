...
// original https://www.shadertoy.com/view/4tGBR1
...
// A Trippy/Psytrance version of https://www.shadertoy.com/view/MtKfzz by beervgeer.
 ...
 st.x -= 0.35;
  ...
  for(int i=0;i<5;i++) {
   ...
   vec3 hue = rgb2hsb(colorNew);
    ...
    hue.y = 0.5;
    hue.y = 0.5;
    glFragColor = vec4( hsb2rgb(hue)-colorNew*0.2 ,1.);
