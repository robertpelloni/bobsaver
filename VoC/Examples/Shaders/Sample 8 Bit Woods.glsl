...
void main( void ) {
    ...
    float g1=smoothstep(0.8,0.9,cos(cos(y*19.)*5.+x*160.)+cos(x*60.)+cos(x*133.)*0.8+y*11.+6.);
    float l1=smoothstep(0.8,0.9,cos(cos(x*30.)*2.0+y*110.)*2.+cos(cos(y*110.)*1.0+x*120.)*2.
    ...
    float g2=smoothstep(0.8,0.9,cos(cos(y*38.)*5.+x*320.)+cos(x*120.)+cos(x*266.)*0.2+y*21.+6.);
    float l2=smoothstep(0.8,0.9,cos(cos(x*60.)*2.0+y*220.)*2.+cos(cos(y*220.)*1.0+x*240.)*2.
    ...
    float g3=smoothstep(0.8,0.9,cos(cos(y*76.)*5.+x*640.)+cos(x*240.)+cos(x*532.)*0.1+y*31.+6.);
    float l3=smoothstep(0.8,0.9,cos(cos(x*120.)*2.0+y*440.)*2.+cos(cos(y*440.)*1.0+x*480.)*2.
    ...
    c=s1;finalColor+=c*vec3(0.4,0.9,0.1);
    c=s2;finalColor+=c*vec3(1.0,0.3,0.7);
    c=s1;finalColor+=c*c*vec3(1)*abs(sin(time*50.));
    c=s2;finalColor+=c*c*vec3(1)*abs(cos(time*50.));
