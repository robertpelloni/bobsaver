...
// original https://www.shadertoy.com/view/Wtl3D2
...
void main(void)
{
    ...
    float wave1 = wave(
        uv + vec2(0., noise(uv * 5. + time * .6) * .05),
        sin((uv.x + time * .2 + .00) * 20.) * .05
    );
    float wave2 = wave(
        uv + vec2(0., noise(uv * 5. + time * .6) * .05),
        sin((uv.x + time * .2 + .01) * 20.) * .05
    );
    float wave3 = wave(
        uv + vec2(0., noise(uv * 5. + time * .6) * .05),
        sin((uv.x + time * .2 + .20) * 20.) * .05
    );
    float wave4 = wave(
        uv + vec2(0., noise(uv * 5. + time * .6) * .05),
        sin((uv.x + time * .2 + .21) * 20.) * .05
    );
    float wave5 = wave(
        uv + vec2(0., noise(uv * 5. + time * .6) * .05),
        sin((uv.x + time * .2 + .40) * 20.) * .05
    );
    float wave6 = wave(
        uv + vec2(0., noise(uv * 5. + time * .6) * .05),
        sin((uv.x + time * .2 + .41) * 20.) * .05
    );
