...
const float kWaterAnimSpeed = 20.0;
const float kTrenchWaterAnimSpeed = 2.0;

float kRipplePos = sqrt(abs(10.0 * kPipeHeight / kWaterAccel)) * kWaterVelocity;
...
C_PointLight GetPointLight()
{
    ...
    result.cColour = vec3(0.1, 0.1, 0.5) * 10.0;
