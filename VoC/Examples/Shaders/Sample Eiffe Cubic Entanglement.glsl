...
//original https://www.shadertoy.com/view/lts3Wn
...
void main() {
    cfg.rmx[0]=vec3(0.0,0.0,0.0);
    cfg.rmx[1]=vec3(0.0,0.0,0.0);
    cfg.rmx[2]=vec3(0.0,0.0,0.0);
    cfg.offset=vec3(0.0,0.0,0.0);
    ...
    for(int i=0;i<64;i++){
        ...
        #ifdef SHOW_INTERSECTIONS
            d=max(d,0.01);
            if(ints>1){glFragColor = vec4(1.0,0.0,0.0,1.0);return;}
            ints=0;
        #endif
