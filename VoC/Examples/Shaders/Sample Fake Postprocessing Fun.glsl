...
// original https://www.shadertoy.com/view/lsSczy
...
void main(void) {
    ...
    vec3 rd = normalize(rotate(vec3(2.*uv,-1.), vec3(0.3,sin(time),0.0)));
    ...
    glFragColor = vec4((pow(color, vec3(1./1.3))+0.05*rand(3.*uv)), 1.);
}
