...
// original https://www.shadertoy.com/view/XdfGzS
...
float dist(vec3 p)//distance function
{
    ...
    float t = time*object_speed_modifier+5.0;
    p.x+=t;    
    p.z+=t*.4;
...
void main(void)
{
    ...
    vec3 mouse = vec3(mouse.xy/resolution.xy - 0.5,0);
    
    float t = time*.5*object_speed_modifier + 10.0;
