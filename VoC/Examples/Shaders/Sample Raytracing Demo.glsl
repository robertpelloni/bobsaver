...
{
    Sphere spheres[3];
    spheres[0] = Sphere(vec3(0.0,3.0+(sin(time)+1.)*3.,10.0),3.0,vec3(1.0,0.0,0.0));
    spheres[1] = Sphere(vec3(-2.0-sin(time)*3.,3.0,0.0),3.0,vec3(0.0,1.0,0.0));
...
void main(void)
{
    ...
    glFragColor = vec4(radiance(ray),1.0);
}
