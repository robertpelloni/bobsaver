...
// original https://www.shadertoy.com/view/WtfBRr
...
vec3 skyColor(vec3 rd){
    ...
    outLight+=addLight(10.*vec3(0.7,0.2,0.3)*sin(time/4.),normalize(-vec3(0.2,0.05,0.2)),rd);
    outLight+=addLight(10.*vec3(0.1,0.3,0.7)*sin(time/4.),normalize(-vec3(-0.2,0.05,-0.2)),rd);
    return outLight;
}
