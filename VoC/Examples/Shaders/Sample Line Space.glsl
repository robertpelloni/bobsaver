...
// original https://www.shadertoy.com/view/3sBXDy
...
void main(void)
{
    ...
    vec2 mouse = (2.0 * (mouse*resolution.xy.xy / R.xy) - 1.0) * 5.0 + 0.1;
    vec3 ro = vec3(mouse, time * 0.5);
    vec3 ta = vec3(0.0, sin(time), time * 0.5 + 1.5);
