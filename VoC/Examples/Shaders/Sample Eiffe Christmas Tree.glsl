...
//original https://www.shadertoy.com/view/ldS3zW
...
void main() {
    ...
    vec3 ro=vec3(4.18,0.32,-6.43)+vec3(sin(time2),sin(time2*2.3),cos(time2*0.7));
    if(time2>60.0)ro=vec3(sin(time2),sin(time2*2.3),cos(time2))*6.0;
