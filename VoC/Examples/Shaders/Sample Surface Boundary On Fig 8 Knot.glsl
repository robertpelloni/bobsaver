...
// original https://www.shadertoy.com/view/Xd3fRf
...
void main(void)
{
    ...
    float depth = exp(4.0*(-1.0+cos(0.25*time)));
    vec2 zoom_endpt = vec2(0.621744414124811, -0.440596998965663);
    vec2 p = zoom_endpt + 1.5*depth*(-resolution.xy+2.0*gl_FragCoord.xy)/resolution.y;
