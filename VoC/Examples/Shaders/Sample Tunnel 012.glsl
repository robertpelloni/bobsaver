...
void main()
{
    ...
    vec3 camPos = vec3(cos(time),sin(time),cos(time)/sin(time));
...
//    glFragColor = vec4(vec3(0.15+glow*0.75, 0.15+glow*0.75, 0.2+glow)*fog + fog2, 1.0) * scanline;
   glFragColor = vec4(vec3(0.15+glow*0.75, 0.15+glow*0.75, 0.8+glow)*fog + fog2, 1.0) * scanline;
