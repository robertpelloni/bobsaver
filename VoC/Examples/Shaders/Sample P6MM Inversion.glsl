...
// original https://www.shadertoy.com/view/MtjGz3
...
void main(void)
{
    center   = 0.5*resolution.xy ;        // viewport center in DC 
    mind   = min(resolution.x,resolution.y);
    ...
    vec2 mou = DCToNDC( 0.5*resolution.xy );
