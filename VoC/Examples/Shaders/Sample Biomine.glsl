...
// original https://www.shadertoy.com/view/4lyGzR
...
/*
    ...
    worse, wanted produce the scene without the help of any in-house textures.
...
float map(vec3 p){
    ...
    p += cos(p.zxy*1.5707963)*.2; // Perturb slightly. The mutation gives it a bit more of an orgainic feel.
...
void main(void) {
    ...
    // Camera Setup.
    vec3 lookAt = vec3(0, 1, time*3. + 0.1);  // "Look At" position.
