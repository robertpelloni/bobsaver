...
// original https://www.shadertoy.com/view/WsycRh
...
//Live coded on stage in 30 minutes while chatting %&*$. Designed in about 4 hours.
...
void main(void)
{
    ...
    glFragColor = vec4(pow(co+g*.2,vec3(.55)),1);
}
