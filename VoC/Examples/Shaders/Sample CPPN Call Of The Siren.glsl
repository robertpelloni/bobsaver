...
// original https://www.shadertoy.com/view/7sSSDd
...
void main(void)
{
    vec2 uv = gl_FragCoord.xy/resolution.xy;
     ...
     vec2 pn = (mouse*resolution.xy.xy/resolution.xy)*vec2(2.0,-2.0)+vec2(-1.,1.0)+vec2(cos(time),sin(time))*0.2;
     pn.y -= 0.2;
     glFragColor = r(( (uv)*vec2(2.0,-2.0)+vec2(-1.,1.0))*vec2(resolution.x/resolution.y,1.0),time,pn); 
