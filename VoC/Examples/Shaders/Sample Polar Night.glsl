...
// original https://www.shadertoy.com/view/3ss3R4
...
void main(void)
{
  ...
  vec3 target = ro + vec3(mix(-0.9, 0.9, (sin(u_time * 0.25 + cos(u_time * 0.05) ))),
                          mix(.5, -.5, abs(sin(u_time * 0.125  + cos(u_time * 0.005)))),
