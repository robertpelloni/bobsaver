...
// original https://neort.io/art/bq0ta8s3p9fefb926ca0
...
void main() {
    ...
    vec3 color = vec3(1.0);
    color.r += snoise(id2 + time * 2.0);
    color += snoise(st + id2 + 2.0 - time);
    color.g -= shape_wave(st * 10.0, 1.0);
    color.b *= shape_wave(st2 * 2.0, 5.0);
    color += triangle(modSt,2.5);
