...
hit scene (ray r) {
    ...
    sphere    (vec3 (-1.0, sin (time) + 3.0,0), 1.0, r, m0, h);
...
vec3 surface (ray r) {
    ...
    for (int i = 0; i < REFLECTIONS; i++) {
        ...
        r = ray (h.p + h.n * 0.0001, reflect (normalize (h.p - r.p), h.n));
