...
void main() {
    ...
    **/
    ...
    //zoomed x3 parameters
    vec3 nr0 = nhd( vec2(1.0,0.0), psn, 0.0, 0, div );
    vec3 nr1 = nhd( vec2(6.0,0.0), psn, 0.0, 0, div );
    vec3 nr2 = nhd( vec2(12.0,3.0), psn, 0.0, 0, div );
    vec3 nr3 = nhd( vec2(21.0,6.0), psn, 0.0, 0, div );
    vec3 nr4 = nhd( vec2(36.0,12.0), psn, 0.0, 0, div );
    vec3 nr5 = nhd( vec2(60.0,21.0), psn, 0.0, 0, div );
    vec3 nr6 = nhd( vec2(99.0,36.0), psn, 0.0, 0, div );
    vec3 nr7 = nhd( vec2(162.0,60.0), psn, 0.0, 0, div );
    vec3 nr8 = nhd( vec2(261.0,99.0), psn, 0.0, 0, div );
